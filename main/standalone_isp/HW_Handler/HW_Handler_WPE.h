...
#ifndef _MTK_HARDWARE_MTKCAM_HW_HANDLER_WPE_H_
#define _MTK_HARDWARE_MTKCAM_HW_HANDLER_WPE_H_

#undef LOG_TAG
#define LOG_TAG "HW_HANDLER_WPE"
 ...
 *
 ******************************************************************************/
class HW_Handler_WPE final : public HW_Handler, protected Thread
{
public:
...
protected:
    ...
    INormalStream*                      mpStream = nullptr;
    bool                                mInited = false;
...
#endif  //_MTK_HARDWARE_MTKCAM_HW_HANDLER_WPE_H_
