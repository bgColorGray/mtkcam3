...
#ifndef _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICE_3_X_UTILS_INCLUDE_APPCONFIGUTIL_H_
#define _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICE_3_X_UTILS_INCLUDE_APPCONFIGUTIL_H_
//
...
public:
    ...
    virtual auto    getAppStreamInfoBuilderFactory(
                    ) const -> std::shared_ptr<IStreamInfoBuilderFactory>;
...
public:
    ...
    auto            extractSMVRBatchInfo(
                        const StreamConfiguration& requestedConfiguration
                    )   -> std::shared_ptr<ParsedSMVRBatchInfo>;

    auto            extractE2EHDRInfo(
                        const StreamConfiguration& requestedConfiguration
                    )   -> MINT32;

    auto            extractDNGFormatInfo(
                        const StreamConfiguration& requestedConfiguration
                    )   -> MINT;

    auto            extractRAW10FormatInfo(
                        const StreamConfiguration& requestedConfiguration
                    )   -> MINT;
...
#endif  //_MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICE_3_X_UTILS_INCLUDE_APPCONFIGUTIL_H_
