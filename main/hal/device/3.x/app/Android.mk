...
DEJITTER_PLATFORM := mt6855 mt6789
ifneq (,$(filter $(DEJITTER_PLATFORM),$(PLATFORM)))
  LOCAL_CFLAGS+=-DSUPPORT_DEJITTER=1
else
  LOCAL_CFLAGS+=-DSUPPORT_DEJITTER=0
endif
...
LOCAL_SRC_FILES += AppStreamMgr.CamDejitter.cpp
LOCAL_SRC_FILES += CallbackHelper.cpp
