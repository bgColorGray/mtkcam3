...
#ifndef _MTK_HARDWARE_MTKCAM_MAIN_HAL_ENTRY_HIDL_INCLUDE_TYPES_WRAPPER_H_
#define _MTK_HARDWARE_MTKCAM_MAIN_HAL_ENTRY_HIDL_INCLUDE_TYPES_WRAPPER_H_
//
...
public:
    ...
    operator V3_2::StreamConfiguration() const
    {
        ...
        for(auto &s : __v35Instance.v3_4.streams) {
            v32Instance.streams[i++] = (V3_2::Stream&)WrappedStream(s);
        }
    ...
    operator V3_2::StreamConfiguration&()
    {
        ...
        int i = 0;
        for(auto &s : __v35Instance.v3_4.streams) {
            __v32Instance.streams[i++] = (V3_2::Stream&)WrappedStream(s);
        }
...
struct WrappedHalStream
{
    ...
    WrappedHalStream(const V3_3::HalStream &p)
    {
    ...
    WrappedHalStream(const V3_6::HalStream &p)
    {
        __v36Instance = p;
    }

    operator V3_2::HalStream() const { return __v36Instance.v3_4.v3_3.v3_2; }
    operator V3_2::HalStream&() { return __v36Instance.v3_4.v3_3.v3_2; }

    operator V3_3::HalStream() const { return __v36Instance.v3_4.v3_3; }
    operator V3_3::HalStream&() { return __v36Instance.v3_4.v3_3; }

    operator V3_4::HalStream() const { return __v36Instance.v3_4; }
    operator V3_4::HalStream&() { return __v36Instance.v3_4; }

    operator V3_6::HalStream() const { return __v36Instance; }
    operator V3_6::HalStream&() { return __v36Instance; }

private:
    V3_6::HalStream __v36Instance;
};
...
struct WrappedHalStreamConfiguration
{
    ...
    {
        __v36Instance.streams = ::android::hardware::hidl_vec<V3_6::HalStream>(p.streams.size());
        int i = 0;
        for(auto &s : p.streams) {
            __v36Instance.streams[i++] = (V3_6::HalStream&)WrappedHalStream(s);
        }
    }
    ...
    WrappedHalStreamConfiguration(const V3_6::HalStreamConfiguration &p)
    {
        __v36Instance = p;
    }
    ...
    operator V3_2::HalStreamConfiguration() const
    {
        ...
        v32Instance.streams = ::android::hardware::hidl_vec<V3_2::HalStream>(__v36Instance.streams.size());
        int i = 0;
        for(auto &s : __v36Instance.streams) {
            v32Instance.streams[i++] = (V3_2::HalStream&)WrappedHalStream(s);
        }
    ...
    {
        __v32Instance.streams = ::android::hardware::hidl_vec<V3_2::HalStream>(__v36Instance.streams.size());
        int i = 0;
        for(auto &s : __v36Instance.streams) {
            __v32Instance.streams[i++] = (V3_2::HalStream&)WrappedHalStream(s);
        }
    ...
    operator V3_3::HalStreamConfiguration() const
    {
        ...
        v33Instance.streams = ::android::hardware::hidl_vec<V3_3::HalStream>(__v36Instance.streams.size());
        int i = 0;
        for(auto &s : __v36Instance.streams) {
            v33Instance.streams[i++] = (V3_3::HalStream&)WrappedHalStream(s);
        }
    ...
    {
        __v33Instance.streams = ::android::hardware::hidl_vec<V3_3::HalStream>(__v36Instance.streams.size());
        int i = 0;
        for(auto &s : __v36Instance.streams) {
            __v33Instance.streams[i++] = (V3_3::HalStream&)WrappedHalStream(s);
        }

        return __v33Instance;
    }

    operator V3_4::HalStreamConfiguration() const {
        V3_4::HalStreamConfiguration v34Instance;
        v34Instance.streams = ::android::hardware::hidl_vec<V3_4::HalStream>(__v36Instance.streams.size());
        int i = 0;
        for(auto &s : __v36Instance.streams) {
            v34Instance.streams[i++] = (V3_4::HalStream&)WrappedHalStream(s);
        }

        return v34Instance;
    }

    operator V3_4::HalStreamConfiguration&() {
        __v34Instance.streams = ::android::hardware::hidl_vec<V3_4::HalStream>(__v36Instance.streams.size());
        int i = 0;
        for(auto &s : __v36Instance.streams) {
            __v34Instance.streams[i++] = (V3_4::HalStream&)WrappedHalStream(s);
        }

        return __v34Instance;
    }

    operator V3_6::HalStreamConfiguration() const { return __v36Instance; }
    operator V3_6::HalStreamConfiguration&() { return __v36Instance; }

private:
    V3_6::HalStreamConfiguration __v36Instance;
...
#endif  //_MTK_HARDWARE_MTKCAM_MAIN_HAL_ENTRY_HIDL_INCLUDE_TYPES_WRAPPER_H_
