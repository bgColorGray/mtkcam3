...
#ifndef _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICEMGR_2_6_CAMERAPROVIDERIMPL_H_
#define _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICEMGR_2_6_CAMERAPROVIDERIMPL_H_
//
...
protected:  ////                Data Members.
    ...
    ::android::sp<V2_4::ICameraProviderCallback>
                                mProviderCallback;
...
public:     //// V2_4
    ...
    virtual Return<Status>      setCallback(const ::android::sp<V2_4::ICameraProviderCallback>& callback) override;
...
public:     //// V2_5
    ...
    virtual Return<void>        notifyDeviceStateChange(hardware::hidl_bitfield<V2_5::DeviceState> newState) override;

public:     //// V2_6

    virtual Return<void>        getConcurrentStreamingCameraIds(getConcurrentStreamingCameraIds_cb _hidl_cb) override;
...
#endif  //_MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICEMGR_2_6_CAMERAPROVIDERIMPL_H_
