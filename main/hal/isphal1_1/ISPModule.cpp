...
Return<void> ISPModule::openISPDevice(openISPDevice_cb _hidl_cb) {
    ...
    android::sp<V1_0::IDevice> pDevice = IISPManager::getInstance()->createISPDevice();
    if (pDevice != nullptr)
    {
...
Return<void> ISPModule::openISPDevice_1_1(openISPDevice_1_1_cb _hidl_cb) {
    return Void();
}
...
{
    ::android::Mutex::Autolock _l(mLock);
    android::sp<IDevice> pDevice = new vendor::mediatek::hardware::camera::isphal::V1_1::implementation::ISPDevice(mDeviceCount);
    if (pDevice != nullptr)
    {
