...
#include <vendor/mediatek/hardware/camera/isphal/1.1/IDevice.h>
...
using ::vendor::mediatek::hardware::camera::isphal::V1_1::IDevice;
...
public:
    ...
    virtual ::android::hardware::Return<void> getISPSupportOutputFormat_1_1(
      getISPSupportOutputFormat_1_1_cb _hidl_cb) override;

    virtual ::android::hardware::Return<void> getISPSupportInputFormat_1_1(
      getISPSupportInputFormat_1_1_cb _hidl_cb) override;
    ...
    virtual ::android::hardware::Return<Status> configureISPDevice_1_1(
      const ::vendor::mediatek::hardware::camera::isphal::V1_1::
          ISPStreamConfiguration& config,
      const ::android::sp<
          ::vendor::mediatek::hardware::camera::isphal::V1_0::ICallback>& Cb)
      override;
    ...
    virtual ::android::hardware::Return<Status> processImgRequest_1_1(
      const hidl_vec<
          ::vendor::mediatek::hardware::camera::isphal::V1_1::ISPRequest>&
          requests) override;
...
private:
    ...
    std::shared_ptr<UserConfigurationParams> mConfigParams = nullptr;
