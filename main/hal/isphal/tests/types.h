...
#define TYPE_MINT32 1
#define TYPE_MINT64 2
...
namespace isphal_test {
    ...
    struct File
    {
        ...
        bool isImage() const
        {
            std::regex rx(".*\\.(yuv|raw|jpeg|jpg)$", std::regex::icase);
            return std::regex_match(fileName, rx);
        };

        bool isRAW() const
        {
            std::regex rx(".*\\.(raw)$", std::regex::icase);
            return std::regex_match(fileName, rx);
        };

        bool isYUV() const
        {
            std::regex rx(".*\\.(yuv)$", std::regex::icase);
            return std::regex_match(fileName, rx);
        };
        ...
        bool isTuning() const
        {
            std::regex rx(".*\\.(tuning)$", std::regex::icase);
            return std::regex_match(fileName, rx);
        };
