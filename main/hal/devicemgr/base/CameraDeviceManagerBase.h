...
#ifndef _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICEMGR_BASE_CAMERADEVICEMANAGERBASE_H_
#define _MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICEMGR_BASE_CAMERADEVICEMANAGERBASE_H_
//
#include <list>
#include <map>
#include <vector>
...
protected:  ////    Operations - utils
    ...
    virtual auto    getDeviceName(
                        const int& deviceId,
                        std::string* rDeviceName
                        ) -> int;

    virtual auto    getDeviceIdWithPhysicalId(
...
public:     ////
    ...
    virtual auto    getConcurrentStreamingDeviceNameList(
    ...
    virtual auto    notifyDeviceStateChange(
...
#endif  //_MTK_HARDWARE_MTKCAM_MAIN_HAL_DEVICEMGR_BASE_CAMERADEVICEMANAGERBASE_H_
