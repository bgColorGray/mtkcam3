...
################################################################################
include $(CLEAR_VARS)
LOCAL_MODULE := libmtkcam_hal_hidl_utils_headers
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += BufferHandleCache.cpp

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
LOCAL_CFLAGS += -DLOG_TAG='"libmtkcam_hal_hidl_utils"'
#
...
LOCAL_HEADER_LIBRARIES += libmtkcam_hal_hidl_utils_headers
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_hidl_utils
