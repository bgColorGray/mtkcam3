...
################################################################################
include $(CLEAR_VARS)
LOCAL_MODULE := libmtkcam_hal_hidl_provider_headers
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += HidlCameraProvider.cpp
LOCAL_SRC_FILES += HidlCameraProviderCallback.cpp

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
LOCAL_CFLAGS += -DLOG_TAG='"libmtkcam_hal_hidl_provider"'
#
...
LOCAL_HEADER_LIBRARIES += libmtkcam_hal_hidl_provider_headers
...
#
LOCAL_SHARED_LIBRARIES += libmtkcam_hal_android_provider
LOCAL_SHARED_LIBRARIES += libmtkcam_hal_hidl_common
LOCAL_SHARED_LIBRARIES += libmtkcam_hal_hidl_device
LOCAL_SHARED_LIBRARIES += libmtkcam_ulog
LOCAL_SHARED_LIBRARIES += libmtkcam_metadata
LOCAL_SHARED_LIBRARIES += libmtkcam_stdutils
#
LOCAL_SHARED_LIBRARIES += libui
# LOCAL_SHARED_LIBRARIES += libmtkcam_hal3ut

#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_hidl_provider
