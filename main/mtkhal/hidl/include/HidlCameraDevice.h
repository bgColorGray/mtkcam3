...
#ifndef MAIN_MTKHAL_HIDL_INCLUDE_HIDLCAMERADEVICE_H_
#define MAIN_MTKHAL_HIDL_INCLUDE_HIDLCAMERADEVICE_H_
//
...
#endif  // MAIN_MTKHAL_HIDL_INCLUDE_HIDLCAMERADEVICE_H_
