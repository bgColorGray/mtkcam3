...
MTKCAM_HAL3PLUS_CUSTOMIZATION_SUPPORT := yes
LOCAL_CFLAGS += -DMTKCAM_HAL3PLUS_CUSTOMIZATION_SUPPORT=1
endif # TODO: add FO in project config
...
LOCAL_CFLAGS += -DLOG_TAG='"libmtkcam_hal_hidl_depend"'
...
# LOCAL_SHARED_LIBRARIES += android.hardware.camera.provider@2.6-custom
endif
#-----------------------------------------------------------
