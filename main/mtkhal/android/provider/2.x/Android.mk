...
################################################################################
include $(CLEAR_VARS)
LOCAL_MODULE := libmtkcam_hal_android_provider_headers
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += ACameraProvider.cpp

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam_hal_android.provider"'
#
...
#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES += libmtkcam_hal_android_provider_headers
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_android_provider
