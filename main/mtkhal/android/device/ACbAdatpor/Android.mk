...
#-----------------------------------------------------------
LOCAL_SRC_FILES += ACallbackAdaptor.cpp
LOCAL_SRC_FILES += ACallbackAdaptor.CoreConverter.cpp
LOCAL_SRC_FILES += ACallbackAdaptor.CallbackHandler.cpp
#-----------------------------------------------------------
...
#
LOCAL_CFLAGS += -DLOG_TAG='"ACbAdptor"'
#
# enable exceptions
...
# LOCAL_SHARED_LIBRARIES += libmtkcam_hal_android_device
# LOCAL_SHARED_LIBRARIES += libmtkcam_hal_core_utils
LOCAL_SHARED_LIBRARIES += libmtkcam_hal_core_app
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_android_app_cbadaptor
