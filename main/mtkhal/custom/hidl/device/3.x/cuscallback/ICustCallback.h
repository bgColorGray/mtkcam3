...
#ifndef MAIN_MTKHAL_DEVICE_3_X_INCLUDE_ICUSTCALLBACK_H_
#define MAIN_MTKHAL_DEVICE_3_X_INCLUDE_ICUSTCALLBACK_H_
...
class ICustCallback : public virtual android::RefBase {
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Definitions
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
...
public:
  ...
  /**
   * @brief Submit a set of requests.
   * This call is valid only after streams are configured successfully.
   */
  virtual auto submitRequests(
      const hidl_vec<CaptureRequest>& rRequests) -> int = 0;

  /**
   * @brief implement processCaptureResult
   */
  virtual auto processCaptureResult(
      const hidl_vec<CaptureResult>& params) -> void = 0;

  /**
   * @brief implement notify
   */
  virtual auto notify(
      const hidl_vec<NotifyMsg>& params) -> void = 0;
   ...
   *
   */
  virtual auto flushRequest(const hidl_vec<CaptureRequest>& requests)
      -> void = 0;
...
#endif  // MAIN_MTKHAL_DEVICE_3_X_INCLUDE_ICUSTCALLBACK_H_