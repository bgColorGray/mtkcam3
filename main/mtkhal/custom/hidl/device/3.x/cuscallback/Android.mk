...
#-----------------------------------------------------------
LOCAL_SRC_FILES += CustCallback.cpp
LOCAL_SRC_FILES += CustCallback.ResultHandler.cpp
LOCAL_SRC_FILES += CustCallback.FrameHandler.cpp
LOCAL_SRC_FILES += CustCallback.CallbackHandler.cpp

#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES += libmtkcam_headers libmtkcam3_headers
LOCAL_HEADER_LIBRARIES += libnativewindow_headers
# LOCAL_HEADER_LIBRARIES += libmtkcam_android_device3_common_headers
LOCAL_HEADER_LIBRARIES += libmtkcam3_hal_device_tinymw_headers

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-CustCallback"'
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_cust_callback
