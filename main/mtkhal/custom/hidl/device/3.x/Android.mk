...
################################################################################
include $(CLEAR_VARS)
LOCAL_MODULE := lib_graphic_headers
...
################################################################################
include $(CLEAR_VARS)
LOCAL_MODULE := lib_feature_headers
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/../../../../../../../..
include $(MTKCAM_BUILD_HEADER_LIBRARY)
...
#
LOCAL_SRC_FILES += graphics/AllocatorHelper.cpp
LOCAL_SRC_FILES += graphics/MapperHelper.cpp
...
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-dev3-custom"'
#
#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES += libmtkcam3_device3_custom_headers
...
LOCAL_HEADER_LIBRARIES += lib_graphic_headers
#
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_device3_custom_graphics
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += CusCameraDevice3.cpp
LOCAL_SRC_FILES += CusCameraDeviceSession.cpp
LOCAL_SRC_FILES += CusCameraOfflineSession.cpp
LOCAL_SRC_FILES += CusCameraDeviceCallback.cpp
#
LOCAL_SRC_FILES += feature/sample/SampleSession.cpp
LOCAL_SRC_FILES += feature/basic/BasicSession.cpp
...
#
LOCAL_STATIC_LIBRARIES += libmtkcam_device3_custom-common-static
#
#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES += libmtkcam3_device3_custom_headers
LOCAL_SHARED_LIBRARIES += liblog
...
LOCAL_SHARED_LIBRARIES += libmtkcam_pipelinemodel_isp
# CusCallback
# LOCAL_SHARED_LIBRARIES += libmtkcam_cust_callback
# Custom features
LOCAL_SHARED_LIBRARIES += libmtkcam_hal3plus
#-----------------------------------------------------------
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/include
LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)/../include

#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_device3_custom
LOCAL_MODULE_OWNER := mtk
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MULTILIB := first
