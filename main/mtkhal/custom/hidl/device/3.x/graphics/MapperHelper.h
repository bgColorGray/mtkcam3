...
#ifndef MAIN_MTKHAL_CUSTOM_HIDL_DEVICE_3_X_GRAPHICS_MAPPERHELPER_H_
#define MAIN_MTKHAL_CUSTOM_HIDL_DEVICE_3_X_GRAPHICS_MAPPERHELPER_H_
...
class MapperHelper : public Singleton<MapperHelper> {
 public:
  ...
  using BufferDescriptor =
      ::android::hardware::graphics::mapper::V4_0::BufferDescriptor;
  ...
  // on error
  void lock(buffer_handle_t bufferHandle,
            uint64_t cpuUsage,
...
#endif  // MAIN_MTKHAL_CUSTOM_HIDL_DEVICE_3_X_GRAPHICS_MAPPERHELPER_H_
