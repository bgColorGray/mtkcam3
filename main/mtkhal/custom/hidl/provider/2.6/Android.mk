...
include $(CLEAR_VARS)
LOCAL_MODULE := libmtkcam_hal_legacy_custom_provider_headers
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += CusCameraProvider.cpp

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-camprovider-custom"'
#
...
LOCAL_HEADER_LIBRARIES += libmtkcam_hal_legacy_custom_provider_headers
...
LOCAL_SHARED_LIBRARIES += libmtkcam_hal_hidl_provider
#-----------------------------------------------------------
LOCAL_MODULE := android.hardware.camera.provider@2.6-custom
