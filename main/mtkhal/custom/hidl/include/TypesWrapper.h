...
#ifndef MAIN_MTKHAL_CUSTOM_HIDL_INCLUDE_TYPESWRAPPER_H_
#define MAIN_MTKHAL_CUSTOM_HIDL_INCLUDE_TYPESWRAPPER_H_
//
...
#endif  // MAIN_MTKHAL_CUSTOM_HIDL_INCLUDE_TYPESWRAPPER_H_
