...
#include <main/mtkhal/core/device/3.x/device/MtkCameraOfflineSession.h>
...
#define ThisNamespace MtkCameraOfflineSession
/******************************************************************************
 *
 ******************************************************************************/
ThisNamespace::~MtkCameraOfflineSession() {
 ...
 *
 ******************************************************************************/
ThisNamespace::MtkCameraOfflineSession(CreationInfo const& info)
    : IMtkcamVirtualOfflineSession(),
 ...
 *
 ******************************************************************************/
void ThisNamespace::setCallback(
 ...
 *
 ******************************************************************************/
int ThisNamespace::close() {
  CAM_ULOG_APILIFE_GUARD(MOD_CAMERA_DEVICE);

  MY_LOGW("Not implement");

  return mcam::core::HAL_OK;
}
};  // namespace core
};  // namespace mcam
