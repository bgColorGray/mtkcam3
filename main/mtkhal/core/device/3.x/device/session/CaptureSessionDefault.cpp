...
#include <main/mtkhal/core/device/3.x/device/session/CaptureSessionDefault.h>
...
#define ThisNamespace CaptureSessionDefault
/******************************************************************************
 *
 ******************************************************************************/
 ...
 *
 ******************************************************************************/
ThisNamespace::ThisNamespace(std::string const& name, CreationInfo const& info)
    : CaptureSessionBase(name, info) {}
};  // namespace core
};  // namespace mcam
