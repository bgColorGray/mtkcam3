...
std::shared_ptr<IMtkcamVirtualDeviceSession> createMtkCameraDeviceSession(
  ...
  return std::static_pointer_cast<IMtkcamVirtualDeviceSession>(
          std::make_shared<mcam::core::MtkCameraDeviceSession>(info));
}