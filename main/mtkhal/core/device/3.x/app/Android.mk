...
#-----------------------------------------------------------
LOCAL_SRC_FILES += CallbackCore.cpp
LOCAL_SRC_FILES += CallbackCore.ResultHandler.cpp
LOCAL_SRC_FILES += CallbackCore.FrameHandler.cpp
# LOCAL_SRC_FILES += CallbackCore.CallbackHandler.cpp
LOCAL_SRC_FILES += CallbackCore.BatchHandler.cpp
...
#
LOCAL_CFLAGS += -DLOG_TAG='"CallbackCore"'
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_core_app
