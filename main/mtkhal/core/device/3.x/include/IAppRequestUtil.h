...
#ifndef MAIN_MTKHAL_CORE_DEVICE_3_X_INCLUDE_IAPPREQUESTUTIL_H_
#define MAIN_MTKHAL_CORE_DEVICE_3_X_INCLUDE_IAPPREQUESTUTIL_H_
//
...
class IAppRequestUtil {
 public:
  virtual ~IAppRequestUtil() = default;
 ...
 public:  ////    Operations.
  // FMQ
  // using ResultMetadataQueue = ::android::hardware::MessageQueue<uint8_t,
  // ::android::hardware::kSynchronizedReadWrite>; using RequestMetadataQueue =
  // ::android::hardware::MessageQueue<uint8_t,
  // ::android::hardware::kSynchronizedReadWrite>;

  // StreamInfo & StreamBuffer
  using AppImageStreamBuffer = mcam::core::Utils::AppImageStreamBuffer;
  using AppMetaStreamBuffer = mcam::core::Utils::AppMetaStreamBuffer;
  ...
  virtual auto setConfigMap(ImageConfigMap& imageConfigMap,
                            MetaConfigMap& metaConfigMap) -> void = 0;
...
#endif  // MAIN_MTKHAL_CORE_DEVICE_3_X_INCLUDE_IAPPREQUESTUTIL_H_
