...
#ifndef MAIN_MTKHAL_CORE_DEVICE_3_X_INCLUDE_IAPPCOMMONSTRUCT_H_
#define MAIN_MTKHAL_CORE_DEVICE_3_X_INCLUDE_IAPPCOMMONSTRUCT_H_
//
...
struct CreationInfo {
  int32_t mInstanceId;
  std::shared_ptr<IMtkcamDeviceCallback> mCameraDeviceCallback;
  ...
  std::shared_ptr<device::policy::PolicyStaticInfo const> mPolicyStaticInfo;
  int64_t iRefineCbRule = -1;
};

};      // namespace Utils
};      // namespace core
};      // namespace mcam
#endif  // MAIN_MTKHAL_CORE_DEVICE_3_X_INCLUDE_IAPPCOMMONSTRUCT_H_
