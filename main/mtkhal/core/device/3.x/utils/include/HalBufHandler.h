...
#ifndef MAIN_MTKHAL_CORE_DEVICE_3_X_UTILS_INCLUDE_HALBUFHANDLER_H_
#define MAIN_MTKHAL_CORE_DEVICE_3_X_UTILS_INCLUDE_HALBUFHANDLER_H_
//
 ...
 * HalBufHandler
 */
class HalBufHandler : public IHalBufHandler, public android::Thread {
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Definitions:
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////
  ...
  // this value sync with
  // /frameworks/av/services/camera/libcameraservice/device3/Camera3Stream.h
  //          static const nsecs_t kWaitForBufferDuration = 3000000000LL; //
  //          3000 ms
 ...
 protected:  ////    Data Members.
  ...
  HalBufImportMap
      mHalBufImportMap;  // map to record buffers which not import yet

  android::Mutex mCntLock;  // mutex for handle mCnt* members
  HalCntMap mCntMaxMap;     // streamId -> max stream buf num
  HalCntMap
      mCntAllocMap;  // streamId -> current allocated of hal buf num (from HIDL)
 ...
 protected:  ////    Operations.
  inline auto getLogLevel() const -> int32_t {
 ...
 private:
  ...
  auto _dequeueHalBufPool(StreamId_T streamId, HalBufSP& rpStreamBufferSP)
      -> bool;
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////    Operations.
  HalBufHandler(const CreationInfo& creationInfo,
  ...
  // virtual auto    getHalBufManagerStreamProvider() ->
  ...
  auto allocHalBuf(HalBufSP& rpStreamBufferSP,
                   IImageStreamBufferProvider::RequestStreamBuffer const& in)
      -> int;
  // auto            decHalBufReqCntByFrame(uint32_t requestNo) -> void;

#warning "Todo: @endConfigureStreams"
  auto setHalBufMaxCnt(const HalStreamConfiguration& halConfiguration)
      -> void;  // configuration max count
#warning "Todo: @submitRequest"
  auto updateHalBufCnt(const std::vector<CaptureRequest>& requests)
      -> void;  // update counting with requests
#warning "Todo: @performCallback"
  auto updateHalBufCnt(const std::vector<CaptureResult>& vBufferResult)
      -> void;  // update counting with results
};
...
#endif  // MAIN_MTKHAL_CORE_DEVICE_3_X_UTILS_INCLUDE_HALBUFHANDLER_H_
