...
################################################################################
include $(CLEAR_VARS)
LOCAL_MODULE := libmtkcam_hal_core_utils_headers
...
#-----------------------------------------------------------
LOCAL_SRC_FILES += streambuffer/AppStreamBuffers.cpp
LOCAL_SRC_FILES += streaminfo/AppImageStreamInfo.cpp
LOCAL_SRC_FILES += AppConfigUtil.cpp
LOCAL_SRC_FILES += AppRequestUtil.cpp
LOCAL_SRC_FILES += HalBufHandler.cpp
LOCAL_SRC_FILES += AppImageStreamBufferProvider.cpp
LOCAL_SRC_FILES += AppStreamBufferBuilder.cpp
LOCAL_SRC_FILES += ZoomRatioConverter.cpp
LOCAL_SRC_FILES += CallbackRecommender.cpp
...
LOCAL_HEADER_LIBRARIES += libmtkcam3_hal_core_utils_tinymw_headers
LOCAL_HEADER_LIBRARIES += libgralloc_metadata_headers
LOCAL_HEADER_LIBRARIES += libmtkcam_hal_core_utils_headers

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-dev3-utils"'
# enable exceptions
...
# set to 1 if AOSP SMVR uses batch mode
LOCAL_CFLAGS += -DEANBLE_SMVR_BATCH=0
#-----------------------------------------------------------
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_core_utils
