...
#ifndef MAIN_MTKHAL_CORE_DEVICE_3_X_MTKCBAPDATOR_MTKCALLBACKADAPTOR_H_
#define MAIN_MTKHAL_CORE_DEVICE_3_X_MTKCBAPDATOR_MTKCALLBACKADAPTOR_H_
//
...
class MtkCallbackAdaptor : public IAppStreamManager {
 ...
 public:
  struct CommonInfo {
    ...
    std::weak_ptr<IMtkcamDeviceCallback> mDeviceCallback;
  ...
  struct MtkCallbackParcel {
    ...
    std::vector<IMetadata> vTempMetadataResult;
  };

  struct MtkCallbackQueue : public std::list<MtkCallbackParcel> {};
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Implementations.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:
 ...
 public:  ////    IAppStreamManager Interfaces.
  ...
  virtual auto updateResult(UpdateResultParams const& params) -> void;

  virtual auto waitUntilDrained(nsecs_t const timeout) -> int;

  virtual auto abortRequest(const android::Vector<Request>& requests) -> void;

  // check if can directly callback to CallbackHandler?
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////    Interfaces.
  explicit MtkCallbackAdaptor(const CreationInfo& creationInfo);
 ...
 * Callback Handler
 */
class MtkCallbackAdaptor::CoreConverter {
  friend class MtkCallbackAdaptor;
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Interfaces.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////    Operations.
  ...
  virtual auto convertResult(UpdateResultParams const& params,
                             ICallbackCore::ResultQueue& resultQueue) -> void;

  ////   UpdateResultParams -> ::mcam::types
  virtual auto convertResult(UpdateResultParams const& params,
                             MtkCallbackParcel& rMtkCbParcel) -> bool;

  ////  callback stage : ICallbackCore::CallbackParcel -> Android::CaptureResult
 ...
 protected:  ////    UpdateResultParams -> ::core::ICallbackCore
  ...
  virtual auto convertAndFillMetaResult(
      UpdateResultParams const& params,
      std::map<uint32_t, ICallbackCore::VecMetaResult>& rMap,
      android::String8& log) -> void;

  virtual auto convertAndFillHalMetaResult(
      UpdateResultParams const& params,
      std::map<uint32_t, ICallbackCore::VecMetaResult>& rMap,
      android::String8& log) -> void;

  virtual auto convertAndFillPhysicMetaResult(
      UpdateResultParams const& params,
      std::map<uint32_t, ICallbackCore::VecPhysicMetaResult>& rMap,
      android::String8& log) -> void;

  virtual auto convertAndFillImageResult(
      uint32_t frameNumber,
      android::Vector<StreamBuffer> const& in,
      std::map<uint32_t, ICallbackCore::VecImageResult>& rMap,
      android::String8& log) -> void;

 protected:  ////    ICallbackCore::CallbackParcel -> ::mtkcamhal_hal::types
  ...
  virtual auto convertHalMetaResult(CallbackParcel const& cbParcel,
                                    std::vector<CaptureResult>& rvResult)
      -> void;
 ...
 * Callback Handler
 */
class MtkCallbackAdaptor::CallbackHandler : public android::Thread {
  friend class MtkCallbackAdaptor;
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Implementation.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 public:  ////    Operations.
  ...
  virtual auto push(const MtkCallbackParcel& item) -> void;
};
/******************************************************************************
 *
 ******************************************************************************/
...
#endif  // MAIN_MTKHAL_CORE_DEVICE_3_X_MTKCBAPDATOR_MTKCALLBACKADAPTOR_H_
