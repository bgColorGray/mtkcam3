...
#-----------------------------------------------------------
LOCAL_SRC_FILES += MtkCallbackAdaptor.cpp
LOCAL_SRC_FILES += MtkCallbackAdaptor.CoreConverter.cpp
LOCAL_SRC_FILES += MtkCallbackAdaptor.CallbackHandler.cpp
#-----------------------------------------------------------
...
#
LOCAL_CFLAGS += -DLOG_TAG='"MtkCbAdptor"'
#
# enable exceptions
...
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_core_app_cbadaptor
