...
#ifndef UTILS_IMGBUF_INCLUDE_IIONIMAGEBUFFERHEAP_H_
#define UTILS_IMGBUF_INCLUDE_IIONIMAGEBUFFERHEAP_H_
//
 ...
 ******************************************************************************/
class IIonImageBufferHeap : public virtual mcam::IImageBufferHeap {
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Interface.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////                    Params for Allocations.
  ...
  struct AllocExtraParam {
    MBOOL contiguousPlanes;
    MINT32 nocache;
    MINT32 security = 0;
    MINT32 coherence = 0;
    NSCam::SecType secType = NSCam::SecType::mem_normal;
    std::shared_ptr<IIonDevice> ionDevice = NULL;
    AllocExtraParam(bool conti, MINT32 _nocache)
        : contiguousPlanes(conti), nocache(_nocache) {}
  };

 public:  ////                    Creation.
  static std::shared_ptr<IIonImageBufferHeap> createPtr(
...
#endif  // UTILS_IMGBUF_INCLUDE_IIONIMAGEBUFFERHEAP_H_
