...
#ifndef UTILS_IMGBUF_INCLUDE_BASEIMAGEBUFFER_H_
#define UTILS_IMGBUF_INCLUDE_BASEIMAGEBUFFER_H_
//
...
using mcam::NSImageBufferHeap::IRegistrationCookie;
 ...
 *  Image Buffer (Base).
 ******************************************************************************/
class BaseImageBuffer : public mcam::IImageBuffer {
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  mcam::IImageBuffer Interface.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ...
 public:  ////                    Image Attributes.
  ...
  virtual std::shared_ptr<mcam::IImageBufferHeap> getImageBufferHeap() const {
  ...
  virtual MINT32 getColorSpace() const {
    return mspImgBufHeap->getColorSpace();
  }
 ...
 public:  ////                    Buffer Attributes.
  ...
  virtual MINT32 getPlaneFD(size_t planeIndex) const;
  virtual size_t getBufOffsetInBytes(size_t index) const;
  virtual size_t getPlaneOffsetInBytes(size_t index) const;
  ...
  virtual NSCam::SecType getSecType() const {
    return mspImgBufHeap->getSecType();
  }
 ...
 public:  ////                    File Operations.
  ...
  virtual MBOOL loadFromFiles(const std::vector<std::string>& vecPlaneFilePath);
 ...
 private:  ////                    Called inside lock.
  ...
  std::unique_ptr<char[], std::function<void(char[])>> toWorldSharedMemory(
      ...
      size_t size);
  MBOOL openFile(int& fd,
                 android::sp<NSCam::IFileCache>& pCache,
                 MBOOL useCache,
                 char const* filepath);
  MBOOL writeFile(int& fd,
                  android::sp<NSCam::IFileCache>& pCache,
                  MBOOL useCache,
                  void* pBuf,
                  size_t size,
                  char const* filepath,
                  size_t index);
  std::vector<std::string> genMultiFilePath(char const* src);
 ...
 public:  ////                       Destructor/Constructors.
  ...
  BaseImageBuffer(shared_ptr<BaseImageBufferHeap> _spImgBufHeap,
                  MSize _imgSize,
                  MINT _imgFormat,
                  size_t _bufSize,
  ...
  virtual std::shared_ptr<mcam::IImageBuffer> clone();
  void dumpBuffer();
 ...
 protected:  ////                    Buffer Info.
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 private:  ////                    Heap Info.
  shared_ptr<BaseImageBufferHeap> mspImgBufHeap;
...
#endif  // UTILS_IMGBUF_INCLUDE_BASEIMAGEBUFFER_H_
