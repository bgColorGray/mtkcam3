...
#-----------------------------------------------------------
LOCAL_SRC_FILES += MtkCameraProvider.cpp

#-----------------------------------------------------------
LOCAL_CFLAGS += $(MTKCAM_CFLAGS)
#
LOCAL_CFLAGS += -DLOG_TAG='"mtkcam-hal-core"'
#
...
#
LOCAL_SHARED_LIBRARIES += libmtkcam_devicemgr
...
LOCAL_SHARED_LIBRARIES += libmtkcam_hal_core_device
LOCAL_SHARED_LIBRARIES += libmtkcam_ulog
#-----------------------------------------------------------
LOCAL_MODULE := libmtkcam_hal_core_provider
