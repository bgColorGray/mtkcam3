...
public:
     ...
     */
    static std::shared_ptr<N3D_HAL> createInstance(const N3D_HAL_INIT_PARAM &n3dInitParam);

    /**
     * \brief Lazy constructor if user init with scenario only, call after createInstance
     *
     * \param n3dInitParam Init param
     */
    virtual void init(const N3D_HAL_INIT_PARAM &n3dInitParam) = 0;
...
public:
     ...
     * \return A new instance
     */
    static std::shared_ptr<N3D_HAL> createInstance(const N3D_HAL_INIT_PARAM_WPE &n3dInitParam);
     ...
     * \param n3dInitParam Init param
     */
    virtual void init(const N3D_HAL_INIT_PARAM_WPE &n3dInitParam) = 0;

    /**
     * \brief Create a N3D_HAL instance by scenario
     * \details User should set to nullptr if no longer used
     *
     * \param scenario Scenario to create
     * \return N3D_HAL instance, different scenario may have different instance
     */
    static std::shared_ptr<N3D_HAL> createInstance(ENUM_STEREO_SCENARIO scenario);

    /**
     * \brief Set convergence
     * \details Set convergence from GF to store to NVRAM
     *
     * \param conv Convergencen to set
     */
    /**
     * \brief Set convergence data
     * \details This data is set from GF
     *
     * \param data Data to set
     * \param len Size of the data in bytes
     */
    virtual void setConvergence(void *data, size_t len) = 0;
