...
public:
    ...
    virtual MINT32 PushLMVStatus(const LMV_ENQUEUE_INFO &enqueInfo);

    virtual MINT32 GetLMVStatusAndUpdate(const MINT32 magicNum);
...
private:
    ...
    std::queue<LMV_ENQUEUE_INFO> mPendingQueue;
