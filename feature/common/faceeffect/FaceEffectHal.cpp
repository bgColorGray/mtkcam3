...
MVOID
FaceEffectHal::
ReturnResult(Request_T &rFrame, MtkCameraFaceMetadata &info, int SD_Detected, int GD_Detected)
{
...
RunFaceEffect(Request_T &rFrameIn)
{
    ...
    */
    ...
    ReturnResult(rFrameIn, mFaceInfo, mSD_Result, mGestureInfo.number_of_faces);
}
