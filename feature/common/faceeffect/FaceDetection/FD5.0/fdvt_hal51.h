...
#ifndef _FDVT_HAL51_H_
#define _FDVT_HAL51_H_
...
*
********************************************************************************/
class halFDVT51: public halFDVT50Base
{
public:
    //
...
private:
    ...
    virtual bool doHWAttribute(void *pCal_Data);
...
protected:
    ...
    //
    mutable std::mutex  mPriorityLock;
};
