...
P2Pack P2Pack::getP2Pack(unsigned sensorID) const
{
    return P2Pack(*this, mLog, sensorID);
}
...
const P2SensorInfo& P2Pack::getMasterSensorInfo() const
{
    return getSensorInfo(getFrameData().mMasterSensorID);
}

const P2SensorData& P2Pack::getMasterSensorData() const
{
    return getSensorData(getFrameData().mMasterSensorID);
}
