...
DipUserParam DIPStream::toDipUserParam(const DipUsageHint &hint) const
{
    NSCam::NSIoPipe::DipUserParam dipUserParam;

    dipUserParam.EnqueDepth = hint.mMaxEnqueDepth;
    dipUserParam.HowManyFrameRepeated = hint.mMaxSubFrameNum;
    dipUserParam.BatchNum = hint.mMaxSMVRBatchNum;
    dipUserParam.DipUser = NSIoPipe::EDipUserEnum_DEFAUT;
