...
ifeq ($(MTKCAM_OPT_MSTREAM),yes)
LOCAL_CFLAGS += -DSUPPORT_MSTREAM
endif
ifeq ($(MTKCAM_OPT_STAGGER),yes)
LOCAL_CFLAGS += -DSUPPORT_STAGGER
endif

# Check option for CaptureFeatureBufferPool
MTKCAM_OPT_CAP_FEATURE_BUF_POOL_BUF_CNT ?= 0
ifeq (($(MTKCAM_OPT_CAP_FEATURE_BUF_POOL_BUF_CNT), 0)
MTKCAM_OPT_CAP_FEATURE_BUF_POOL_VER := default
else
MTKCAM_OPT_CAP_FEATURE_BUF_POOL_VER ?= default
endif
LOCAL_CFLAGS += -DCAP_FEATURE_BUF_POOL_BUF_CNT=$(MTKCAM_OPT_CAP_FEATURE_BUF_POOL_BUF_CNT)
$(info CaptureFeatureBufferPool ver=$(MTKCAM_OPT_CAP_FEATURE_BUF_POOL_VER) cnt=$(MTKCAM_OPT_CAP_FEATURE_BUF_POOL_BUF_CNT))

LOCAL_SRC_FILES += ImageBufferUtils.cpp
LOCAL_SRC_FILES += FeatureCache.cpp
...
LOCAL_SRC_FILES += CaptureFeatureBufferPool/$(MTKCAM_OPT_CAP_FEATURE_BUF_POOL_VER)/CaptureFeatureBufferPool.cpp
...
LOCAL_CFLAGS += -DMTK_HDR10_PLUS_RECORDING
endif
