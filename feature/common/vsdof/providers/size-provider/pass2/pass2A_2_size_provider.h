...
public:
    ...
    virtual StereoArea getWDMAArea( P2SizeQueryParam param ) const {
        BufferSizeQueryParam bufferParam(E_RECT_IN_M, param);
    ...
    virtual StereoArea getIMG2OArea( P2SizeQueryParam param) const {
        return (Pass2A_SizeProvider::instance()->getWROTArea(param)*0.5f);
    }

    virtual StereoArea getFEOInputArea( P2SizeQueryParam param ) const {
        return Pass2A_SizeProvider::instance()->getWROTArea(param).apply4Align();
    }
protected:
