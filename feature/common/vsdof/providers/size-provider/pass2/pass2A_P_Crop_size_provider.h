    ...
    virtual StereoArea getWDMAArea( P2SizeQueryParam param ) const  {
            ...
            eSTEREO_SCENARIO_CAPTURE == param.eScenario )
        {
            StereoSizeProvider::getInstance()->
                getPass1Size( { eSTEREO_SENSOR_MAIN2, eImgFmt_BAYER10,
            ...
            if(!StereoSettingProvider::is3rdParty()) {
                CropUtil::cropStereoAreaByFOV(eSTEREO_SENSOR_MAIN2, area,
            ...
            MRect tgCropRect1X;
            StereoSizeProvider::getInstance()->
                getPass1Size( { eSTEREO_SENSOR_MAIN2, eImgFmt_FG_BAYER10,
            ...
            if(param.previewCropRatio < 1.0f) {
                ...
                if(p1Scale > param.previewCropRatio) {
                    ...
                    szMain2Output.w *= p2Scale;
                    szMain2Output.h *= p2Scale;
                    area.padding = area.size - szMain2Output;
