...
public:
    StereoSizeProviderUTBase()
    {
        ...
        cin >> input;
        const MUINT32 EIS_FACTOR = (scenario == eSTEREO_SCENARIO_RECORD) ? 119 : 1;
        const bool IS_PORTRAIT = false;
        const bool IS_RECORD = (scenario == eSTEREO_SCENARIO_RECORD);
        switch(input) {
            case 0:
            default:
        ...
        // Bokeh + zoom
        printf("Set preview crop ratio[0.3~1.0]: ");
        float ratio = 1.0f;
        cin >> ratio;
        StereoSettingProvider::setPreviewCropRatio(ratio);
        ...
        case E_STEREO_FEATURE_MTK_DEPTHMAP:
            printf("Feature Mode: Mtkdepthmap\n");
            break;
        case E_STEREO_FEATURE_THIRD_PARTY:
            printf("Feature Mode: 3rd Party\n");
            break;
        case E_DUALCAM_FEATURE_ZOOM:
            printf("Feature Mode: Zoom\n");
            break;
        case E_STEREO_FEATURE_MULTI_CAM:
            printf("Feature Mode: Multicam \n");
            break;
...
protected:
    virtual void SetUp() {
        ...
        //  PASS 2
        //=============================================================================
        sizeProvider->getPass2SizeInfo(PASS2A,          scenario,   pass2SizeInfo[PASS2A],     false);
        sizeProvider->getPass2SizeInfo(PASS2A_2,        scenario,   pass2SizeInfo[PASS2A_2],   false);
        sizeProvider->getPass2SizeInfo(PASS2A_3,        scenario,   pass2SizeInfo[PASS2A_3],   false);
        sizeProvider->getPass2SizeInfo(PASS2A_P,        scenario,   pass2SizeInfo[PASS2A_P],   false);
        sizeProvider->getPass2SizeInfo(PASS2A_P_2,      scenario,   pass2SizeInfo[PASS2A_P_2], false);
        sizeProvider->getPass2SizeInfo(PASS2A_P_3,      scenario,   pass2SizeInfo[PASS2A_P_3], false);
        sizeProvider->getPass2SizeInfo(PASS2A_B,        scenario,   pass2SizeInfo[PASS2A_B],   false);
        ...
        sizeProvider->getPass2SizeInfo(PASS2A,          scenario,   pass2SizeInfo[PASS2A+PASS2_ROUND_COUNT],     true);
        sizeProvider->getPass2SizeInfo(PASS2A_2,        scenario,   pass2SizeInfo[PASS2A_2+PASS2_ROUND_COUNT],   true);
        sizeProvider->getPass2SizeInfo(PASS2A_3,        scenario,   pass2SizeInfo[PASS2A_3+PASS2_ROUND_COUNT],   true);
        sizeProvider->getPass2SizeInfo(PASS2A_P,        scenario,   pass2SizeInfo[PASS2A_P+PASS2_ROUND_COUNT],   true);
        sizeProvider->getPass2SizeInfo(PASS2A_P_2,      scenario,   pass2SizeInfo[PASS2A_P_2+PASS2_ROUND_COUNT], true);
        sizeProvider->getPass2SizeInfo(PASS2A_P_3,      scenario,   pass2SizeInfo[PASS2A_P_3+PASS2_ROUND_COUNT], true);
    }
...
protected:
    ...
    //Pass 2
    Pass2SizeInfo pass2SizeInfo[PASS2_ROUND_COUNT+6];
