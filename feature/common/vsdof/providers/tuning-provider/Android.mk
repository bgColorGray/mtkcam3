...
# STEREO_TUNINGS_FOLDER may be fefined in mtkcam_opt
...
else ifneq ($(wildcard $(LOCAL_PATH)/$(PLATFORM)),)
	STEREO_TUNINGS_FOLDER ?= $(PLATFORM)
else ifdef STEREO_ISP_FOLDER
	ifneq ($(wildcard $(LOCAL_PATH)/$(STEREO_ISP_FOLDER)),)
		STEREO_TUNINGS_FOLDER ?= $(STEREO_ISP_FOLDER)
		# workaround
...
STEREO_TUNINGS_FOLDER := $(LOCAL_PATH)/$(STEREO_TUNINGS_FOLDER)
