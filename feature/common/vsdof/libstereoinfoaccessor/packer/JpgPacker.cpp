...
void JpgPacker::pack() {
    StereoLogD("<JpgPacker::pack> begin");
    ...
    for (int i = 0; i < srcJpgSectionsSize; i++) {
        ...
        if (PackUtils::TYPE_STANDARD_XMP == sec->type) {
            try {
                ...
                StereoLogE("<unpack> error, index out of boundary-1");
            }
        ...
        if (PackUtils::TYPE_EXTENDED_XMP == sec->type) {
            try {
                ...
                StereoLogE("<unpack> error, index out of boundary-2");
            }
        ...
        if (PackUtils::TYPE_DEPTH_DATA == sec->type
            ...
            try {
                ...
                StereoLogE("<unpack> error, index out of boundary-3");
            }
...
StereoVector<Section*>* JpgPacker::parseAppInfoFromStream(BufferTypeInputStream &is) {
    ...
    try {
        ...
        StereoLogE("<parseAppInfoFromStream 1> error, index out of boundary(index: 0)");
    }
    ...
    try {
        ...
        StereoLogE("<parseAppInfoFromStream 2> error, index out of boundary(index: 0)");
    }
...
void JpgPacker::checkAppSectionTypeInStream(BufferTypeInputStream &is, Section *section) {
    ...
    if (section->marker == PackUtils::APP15) {
        try {
            ...
            StereoLogE("<checkAppSectionTypeInStream> error 1, index out of boundary");
        }
        ...
        try {
            ...
            StereoLogE("<checkAppSectionTypeInStream> error 2, index out of boundary");
        }
        StereoBuffer_t buffer;
...
void JpgPacker::writeSectionToStream(BufferTypeInputStream &is, BufferTypeOutputStream &os,
    ...
    try {
        ...
        StereoLogE("<writeSectionToStream> error, index out of boundary");
    }
    StereoBuffer_t buffer;
...
void JpgPacker::writeImageBuffer(BufferTypeInputStream &blurImageIs,
    ...
    try {
        ...
        StereoLogE("<writeImageBuffer> error, index out of boundary(index: 0)");
    }
...
void JpgPacker::pack(BufferTypeInputStream &is, BufferTypeOutputStream &os,
    ...
    delete srcJpgSections;
    StereoLogD("<JpgPacker::pack..> write end!!!");
}