...
N3D_HAL_KERNEL::dumpN3DInitConfig()
{
    ...
    if(0 == __initInfoJSON.size()) {
        ...
        initInfoJson["iio_main"]["wpe_img_rotate_type"] = __algoInitInfo.iio_main.wpe_img_rotate_type;
        ...
        initInfoJson["iio_auxi"]["wpe_img_rotate_type"] = __algoInitInfo.iio_auxi.wpe_img_rotate_type;
        ...
        for(int level = 0; level < MAX_GEO_LEVEL; level++) {
            ...
            initInfoJson["geo_img"][level]["img_main"]["rot_width"]  = geoInfo.img_main.rot_width;
            initInfoJson["geo_img"][level]["img_main"]["rot_height"] = geoInfo.img_main.rot_height;
            ...
            initInfoJson["geo_img"][level]["img_auxi"]["rot_width"]  = geoInfo.img_auxi.rot_width;
            initInfoJson["geo_img"][level]["img_auxi"]["rot_height"] = geoInfo.img_auxi.rot_height;
        }
        ...
        initInfoJson["system_cfg(binary)"] = std::bitset<32>(__algoInitInfo.system_cfg).to_string();
        initInfoJson["module_angle"] = __algoInitInfo.module_angle;
        initInfoJson["dpe_convergence_offset"] = __algoInitInfo.dpe_convergence_offset;
    ...
    MY_LOGE_IF(fwrite(__initInfoJSON.c_str(), 1, __initInfoJSON.size(), fp) == 0, "Write failed");
...
N3D_HAL_KERNEL::dumpN3DRuntimeConfig()
{
    ...
    KeepOrderJSON procInfoJson;

    procInfoJson["runtime_cfg"] = __algoProcInfo.runtime_cfg;

    procInfoJson["rrz_proc_main"]["rrz_offset_x"]     = __algoProcInfo.rrz_proc_main.rrz_offset_x;
    procInfoJson["rrz_proc_main"]["rrz_offset_y"]     = __algoProcInfo.rrz_proc_main.rrz_offset_y;
    procInfoJson["rrz_proc_main"]["rrz_usage_width"]  = __algoProcInfo.rrz_proc_main.rrz_usage_width;
    procInfoJson["rrz_proc_main"]["rrz_usage_height"] = __algoProcInfo.rrz_proc_main.rrz_usage_height;
    procInfoJson["rrz_proc_main"]["rrz_out_width"]    = __algoProcInfo.rrz_proc_main.rrz_out_width;
    procInfoJson["rrz_proc_main"]["rrz_out_height"]   = __algoProcInfo.rrz_proc_main.rrz_out_height;
    procInfoJson["rrz_proc_auxi"]["rrz_offset_x"]     = __algoProcInfo.rrz_proc_auxi.rrz_offset_x;
    procInfoJson["rrz_proc_auxi"]["rrz_offset_y"]     = __algoProcInfo.rrz_proc_auxi.rrz_offset_y;
    procInfoJson["rrz_proc_auxi"]["rrz_usage_width"]  = __algoProcInfo.rrz_proc_auxi.rrz_usage_width;
    procInfoJson["rrz_proc_auxi"]["rrz_usage_height"] = __algoProcInfo.rrz_proc_auxi.rrz_usage_height;
    procInfoJson["rrz_proc_auxi"]["rrz_out_width"]    = __algoProcInfo.rrz_proc_auxi.rrz_out_width;
    procInfoJson["rrz_proc_auxi"]["rrz_out_height"]   = __algoProcInfo.rrz_proc_auxi.rrz_out_height;
