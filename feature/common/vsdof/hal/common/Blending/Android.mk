...
#-----------------------------------------------------------
LOCAL_SRC_FILES += blending_hal_imp.cpp
LOCAL_SRC_FILES += blending_hal_imp.log.cpp
LOCAL_SRC_FILES += blending_hal_imp.dump.cpp
...
#-----------------------------------------------------------
LOCAL_SHARED_LIBRARIES += libdpframework # for DpDataType.h
LOCAL_SHARED_LIBRARIES += libmtkcam_ulog

#-----------------------------------------------------------
LOCAL_MODULE := libfeature.vsdof.hal.blending
