...
LOCAL_C_INCLUDES += $(TOP)/$(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/$(MTK_CAM_SW_VERSION)
LOCAL_C_INCLUDES += $(TOP)/$(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning
...
LOCAL_SENSOR_HUB_OIS := false
ifeq ($(LOCAL_SENSOR_HUB_OIS),true)
    LOCAL_CFLAGS += -DSENSOR_HUB_OIS
endif
