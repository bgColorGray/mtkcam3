...
public:
    ...
    virtual MVOID setBufferPool(const android::sp<CaptureBufferPool> &pool);
...
private:
    ...
    MVOID updateSelInfo(Selection& sel, CaptureFeatureInferenceData& rInference);
    ...
    struct PluginRawBufType{
        MBOOL mPluginIBufProcessRaw;
        MINT mPluginPreferRawType;
    };
    ...
    KeyedVector<FeatureID_T, PluginRawBufType>  mPluginRawBufType;
    MBOOL                                       mRawTransDump = MFALSE;
