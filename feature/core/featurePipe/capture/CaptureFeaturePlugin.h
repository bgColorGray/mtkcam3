...
public:
    ...
    std::vector<IImageBuffer*> acquireAll(MINT usage) override;
...
private:
    ...
    std::vector<IImageBuffer*>      mpImageBuffers;
 ...
 * @brief implemented class of the NSPipelinePlugin::BufferHandle
 */
class PluginSmartBufferHandle : public NSPipelinePlugin::BufferHandle
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Type Alias.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    explicit PluginSmartBufferHandle(const char* name, const android::sp<IIBuffer>& imgBuffer);
