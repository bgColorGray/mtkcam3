...
// platform code
#if CAPTURE_PIPE_IPVER == 65
    #include "nodes/isp6s/P2ANode.h"
#else
    #include "nodes/default/P2ANode.h"
#endif
...
private:
    ...
    FusionNode*     mpFusionVsdofNode;
    FusionNode*     mpFusionZoomNode;
    ...
    std::shared_ptr<NSCam::ICaptureFeatureBufferPool>  mpFeatureBufferPool;
