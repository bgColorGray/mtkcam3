...
public:
    ...
    MUINT32 getTPILength(const TPIOEntry &entry, const bool skipQueueCount=false) const;
    MUINT32 getNumInBuffer(const TPIOEntry &entry) const;
    MUINT32 getNumOutBuffer(const TPIOEntry &entry) const;
