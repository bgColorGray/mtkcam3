...
public:
    ...
    MBOOL process(MUINT32 scenarioFPS, IImageBuffer *src, const OUTPUT_ARRAY &dst, MBOOL printIO=MFALSE, MUINT32 cycleTimeMs = 0);
    MBOOL process(MUINT32 scenarioFPS, IImageBuffer *src, const P2IO_OUTPUT_ARRAY &dst, MBOOL printIO=MFALSE, MUINT32 cycleTimeMs = 0);
    MBOOL process(MUINT32 scenarioFPS, IImageBuffer *src, IImageBuffer *dst, MBOOL printIO=MFALSE, MUINT32 cycleTimeMs = 0);
...
private:
    ...
    MBOOL prepareMDPOut(MUINT32 outSize, MUINT32 cycleTimeMs, MUINT32 scenarioFPS);
    ...
    MVOID dumpInfo(IImageBuffer *src, const OUTPUT_ARRAY &dst, MUINT32 cycleTimeMs, MUINT32 scenarioFPS);
