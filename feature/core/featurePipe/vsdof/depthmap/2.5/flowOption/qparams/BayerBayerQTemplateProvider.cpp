...
)
{
    ...
    else
    {
        ...
        MINT32 iModuleTrans = remapTransform((int)rotDeg);
...
)
{
    ...
    int moduleRot = StereoSettingProvider::getModuleRotation();
    MINT32 iModuleTrans = remapTransformForPostview((int)moduleRot, (int)jpegOrientation);
    // tuning buffer
    MVOID* pTuningBuf = pBufferHandler->requestWorkingTuningBuf(nodeID, BID_P2A_TUNING);
