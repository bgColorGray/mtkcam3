...
DepthMapBufferID bufIDs_P2A_TO_N3D_RECT2_FEO[] =
{
    ...
    BID_P2A_FE2B_INPUT, BID_P2A_FE2C_INPUT,
    BID_P2A_INTERNAL_FD,
    // end with this
    BID_INVALID
};
...
{
    BID_P2A_OUT_RECT_IN2, BID_P2A_INTERNAL_FD,
    // end with this
    BID_INVALID
};
...
{
    BID_P2A_FE1B_INPUT, BID_P2A_FE1C_INPUT, BID_P2A_FE2B_INPUT, BID_P2A_FE2C_INPUT,
...
DepthMapBufferID bufIDs_P2A_TO_N3D_FEOFMO_NDD_L1[] =
{
    BID_P2A_FE1B_INPUT, BID_P2A_FE1C_INPUT, BID_P2A_FE2B_INPUT, BID_P2A_FE2C_INPUT,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_N3D_TO_WPE_RECT2_WARPMTX[] =
{
    ...
    BID_P2A_OUT_RECT_IN1, BID_P2A_OUT_RECT_IN2,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_N3D_TO_WPE_WARPMTX[] =
{
    BID_N3D_OUT_MV_Y,
    BID_N3D_OUT_WARPMTX_MAIN2_X, BID_N3D_OUT_WARPMTX_MAIN2_Y,
    // end with this
...
DepthMapBufferID bufIDs_N3D_TO_DVS_MVSV_MASK[] =
{
...
DepthMapBufferID bufIDs_WPE_TO_DVS_WARP_IMG[] =
{
    BID_WPE_IN_MASK_S,
    BID_WPE_OUT_SV_Y, BID_WPE_OUT_MASK_S,
    // end with this
...
DepthMapBufferID bufIDs_TO_DUMP_YUVS[] =
{
    BID_P2A_IN_YUV1, BID_P1_OUT_RECT_IN1,
    BID_P2A_IN_YUV2, BID_P1_OUT_RECT_IN2,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_TO_DUMP_YUVS_NDD_L1[] =
{
    BID_P1_OUT_RECT_IN1, BID_P1_OUT_RECT_IN2,
    // end with this
    BID_INVALID
};
...
DepthMapBufferID bufIDs_P2A_TO_DVP_MY_S[] =
{
    BID_P2A_OUT_MY_S,
...
DepthMapBufferID bufIDs_P2A_TO_DLDEPTH_MY_S[] =
{
    BID_P2A_OUT_MY_S,
    BID_P2A_FE1B_INPUT_NONSLANT,
    // end with this
...
{
    BID_GF_OUT_DMBG, BID_DVS_OUT_UNPROCESS_DEPTH,
    // end with this
    BID_INVALID
};
...
{
    BID_GF_INTERNAL_DMBG, BID_GF_OUT_DMBG,
    // end with this
    BID_INVALID
};
...
DepthMapBufferID bufIDs_DLDEPTH_OUT_INTERNAL_DEPTH[] =
{
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_DVS_OUT_INTERNAL_DEPTH[] =
{
    BID_OCC_OUT_NOC_M,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_DVP_OUT_INTERNAL_DEPTH[] =
{
...
DepthMapBufferID bufIDs_SLANT_OUT_INTERNAL_DMBG[] =
{
...
DepthMapBufferID bufIDs_DLDEPTH_OUT_DEPTHMAP[] =
{
    ...
    BID_DVS_OUT_UNPROCESS_DEPTH,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_DLDEPTH_TO_GF_DEPTHMAP[] =
{
    BID_DLDEPTH_INTERNAL_DEPTHMAP,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_DLDEPTH_TO_SLANT_DEPTH[] =
{
    BID_DLDEPTH_INTERNAL_DEPTHMAP,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_DVS_OUT_DEPTHMAP[] =
{
    BID_OCC_OUT_CFM_M, BID_OCC_OUT_NOC_M,
    BID_DVS_OUT_UNPROCESS_DEPTH,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_GF_OUT_INTERNAL_DEPTH[] =
{
...
DepthMapBufferID bufIDs_DVP_OUT_DEPTHMAP[] =
{
    BID_ASF_OUT_CRM, BID_ASF_OUT_RD, BID_ASF_OUT_HF, BID_WMF_OUT_DMW,
    BID_DVS_OUT_UNPROCESS_DEPTH,
    // end with this
...
DepthMapBufferID bufIDs_SLANT_OUT_DEPTHMAP[] =
{
    BID_DVS_OUT_UNPROCESS_DEPTH,
    // end with this
    BID_INVALID
...
DepthMapBufferID bufIDs_SLANT_TO_DVP_NOC_CFM[] =
{
    BID_OCC_OUT_NOC_M_NONSLANT, BID_OCC_OUT_CFM_M_NONSLANT,
    // end with this
    BID_INVALID
};

DepthMapBufferID bufIDs_SLANT_TO_GF_DEPTH_CFM[] =
{
...
DepthMapBufferID bufIDs_DVP_TO_GF_DMW_N_DEPTH[] =
{
    BID_OCC_OUT_CFM_M, BID_OCC_OUT_NOC_M,
    BID_ASF_OUT_CRM, BID_ASF_OUT_RD, BID_ASF_OUT_HF, BID_WMF_OUT_DMW,
    // end with this
...
DepthMapBufferID bufIDs_DVP_TO_GF_DMW_N_DEPTH_NDD_L1[] =
{
    BID_OCC_OUT_CFM_M, BID_OCC_OUT_NOC_M,
    BID_WMF_OUT_DMW,
    // end with this
...
DepthMapBufferID bufIDs_DVS_TO_DLDEPTH_MVSV_NOC[] =
{
    BID_OCC_OUT_CFM_M, BID_OCC_OUT_NOC_M,
...
DepthMapBufferID bufIDs_DVS_TO_DVP_NOC_CFM[] =
{
    BID_OCC_OUT_CFM_M, BID_OCC_OUT_NOC_M,
    BID_N3D_OUT_MASK_M_STATIC,
    // end with this
...
DepthMapBufferID bufIDs_DVS_TO_SLANT_NOC_CFM[] =
{
    BID_OCC_OUT_CFM_M, BID_OCC_OUT_NOC_M,
    BID_N3D_OUT_MASK_M_STATIC,
    // end with this
...
DataIDToBIDMap getDataIDToBIDMap()
{
    ...
    ADD_TO_DBIDMAP(P2A_TO_DVP_MY_S);
    ADD_TO_DBIDMAP(P2A_TO_DLDEPTH_MY_S);
    ADD_TO_DBIDMAP(N3D_TO_WPE_RECT2_WARPMTX);
    ADD_TO_DBIDMAP(N3D_TO_WPE_WARPMTX);
    ADD_TO_DBIDMAP(N3D_TO_DVS_MVSV_MASK);
    ADD_TO_DBIDMAP(WPE_TO_DVS_WARP_IMG);
    ADD_TO_DBIDMAP(WPE_TO_DLDEPTH_MV_SV);
    ADD_TO_DBIDMAP(P2A_TO_N3D_FEOFMO);
    ADD_TO_DBIDMAP(P2A_TO_N3D_FEOFMO_NDD_L1);
    ADD_TO_DBIDMAP(DVP_TO_GF_DMW_N_DEPTH);
    ADD_TO_DBIDMAP(DVP_TO_GF_DMW_N_DEPTH_NDD_L1);
    ADD_TO_DBIDMAP(DVS_TO_DLDEPTH_MVSV_NOC);
    ADD_TO_DBIDMAP(DVS_TO_DVP_NOC_CFM);
    ADD_TO_DBIDMAP(DVP_OUT_INTERNAL_DEPTH);
    ADD_TO_DBIDMAP(DVP_OUT_DEPTHMAP);
    ...
    ADD_TO_DBIDMAP(DVS_OUT_INTERNAL_DEPTH);
    ADD_TO_DBIDMAP(DVS_OUT_DEPTHMAP);
    ADD_TO_DBIDMAP(DVS_TO_SLANT_NOC_CFM);
    ADD_TO_DBIDMAP(DLDEPTH_OUT_INTERNAL_DEPTH);
    ADD_TO_DBIDMAP(DLDEPTH_OUT_DEPTHMAP);
    ADD_TO_DBIDMAP(DLDEPTH_TO_GF_DEPTHMAP);
    ADD_TO_DBIDMAP(DLDEPTH_TO_SLANT_DEPTH);
    ADD_TO_DBIDMAP(SLANT_TO_DVP_NOC_CFM);
    ADD_TO_DBIDMAP(SLANT_TO_GF_DEPTH_CFM);
    ADD_TO_DBIDMAP(SLANT_OUT_DEPTHMAP);
    ADD_TO_DBIDMAP(TO_DUMP_IMG3O);
    ADD_TO_DBIDMAP(TO_DUMP_YUVS);
    ADD_TO_DBIDMAP(TO_DUMP_RAWS);
    ADD_TO_DBIDMAP(TO_DUMP_YUVS_NDD_L1);
