...
, mProfile(profile)
{
    ...
    STEREO_IMAGE_RATIO_T ratio(profile.imageRatio);
    ...
    #ifdef GTEST_PROFILE
    DepthPipeLoggingSetup::miDebugLog = 2;
    #else
    DepthPipeLoggingSetup::miDebugLog = 2;
    #endif
...
MBOOL setupReqMetadata(MBOOL eisON, sp<IDepthMapEffectRequest> pRequest)
{
    ...
    // request No
    trySetMetadata<MINT32>(pMetadata, MTK_PIPELINE_REQUEST_NUMBER, pRequest->getRequestNo());
    // InHalMain2
    pMetadata = new IMetadata();
    trySetMetadata<MINT32>(pMetadata, MTK_P1NODE_PROCESSOR_MAGICNUM, 0);
...
MVOID loadFullResizRawsImgBuf(
    ...
    sp<IImageBuffer>& rpRectInMain1ImgBuf,
...
)
{
    ...
    // MUINT32 bufStridesInBytes[3] = {960, 480, 480};
    // MINT32 bufBoundaryInBytes[3] = {0, 0, 0};
    // IImageBufferAllocator::ImgParam imgParamRRZO_Main1 = IImageBufferAllocator::ImgParam(eImgFmt_YV12, getRRZOMain1Size(), bufStridesInBytes, bufBoundaryInBytes, 3);

    // MUINT32 bufStridesInBytes2[3] = {960, 480, 480};
    // IImageBufferAllocator::ImgParam imgParamRRZO_Main2 = IImageBufferAllocator::ImgParam(eImgFmt_YV12, getRRZOMain1Size(), bufStridesInBytes2, bufBoundaryInBytes, 3);
    ...
    // Input YUV
    const char * sMain1Filename = "/sdcard/vsdof_data/054551012-0009-0009-main2-imgo__1152x648_10_i0__CRSP_R1A_Output[4]";
    const char * sMain2Filename = "/sdcard/vsdof_data/054551012-0009-0009-main2-imgo__1152x648_10_s1__CRSP_R1A_Output[4].yuv420";

    MUINT32 bufStridesInBytes[3] = {1920*10/8, 1920*2, 1920*2};
    MINT32 bufBoundaryInBytes[3] = {0, 0, 0};
    IImageBufferAllocator::ImgParam imgParamRRZO_Main1 = IImageBufferAllocator::ImgParam(eImgFmt_NV12, MSize(1920,1080), bufStridesInBytes, bufBoundaryInBytes, 2);

    MUINT32 bufStridesInBytes2[3] = {1920*10/8, 1920*2, 1920*2};
    IImageBufferAllocator::ImgParam imgParamRRZO_Main2 = IImageBufferAllocator::ImgParam(eImgFmt_NV12, MSize(1920,1080), bufStridesInBytes2, bufBoundaryInBytes, 2);

    // rpRSMain1ImgBuf = createImageBufferFromFile(imgParamRRZO_Main1, sMain1Filename, "RsYuv1",  eBUFFER_USAGE_HW_CAMERA_READWRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_OFTEN);
    // rpRSMain2ImgBuf = createImageBufferFromFile(imgParamRRZO_Main2, sMain2Filename, "RsYuv2",  eBUFFER_USAGE_HW_CAMERA_READWRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_OFTEN);

    rpRSMain1ImgBuf = createEmptyImageBuffer(imgParamRRZO_Main1, "RsYuv1", eBUFFER_USAGE_HW_CAMERA_READWRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_OFTEN);
    rpRSMain2ImgBuf = createEmptyImageBuffer(imgParamRRZO_Main2, "RsYuv2", eBUFFER_USAGE_HW_CAMERA_READWRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_OFTEN);

    //
    const char * sRect1Filename = "/sdcard/vsdof_data/054551012-0009-0009-main-imgo__484x272_8d_i0__RSS_R2A";
    const char * sRect2Filename = "/sdcard/vsdof_data/054551012-0009-0009-main-imgo__484x272_8d_s1__RSS_R2A";
    IImageBufferAllocator::ImgParam p1RectIn1_param = getImgParam_RSSOR2Main1(eSTEREO_SCENARIO_RECORD);
    IImageBufferAllocator::ImgParam p1RectIn2_param = getImgParam_RSSOR2Main2(eSTEREO_SCENARIO_RECORD);
    MY_LOGD("MAIN2 RSSOR2_FORMAT :%d", p1RectIn2_param.imgFormat);

    // MUINT32 bufStridesInBytes_Rect1[3] = {484, 0, 0};
    // IImageBufferAllocator::ImgParam p1RectIn1_param = IImageBufferAllocator::ImgParam(eImgFmt_YUY2, MSize(484,272), bufStridesInBytes_Rect1, bufBoundaryInBytes, 1);
    // MUINT32 bufStridesInBytes_Rect2[3] = {484, 0, 0};
    // IImageBufferAllocator::ImgParam p1RectIn2_param = IImageBufferAllocator::ImgParam(eImgFmt_YUY2, MSize(484,272), bufStridesInBytes_Rect2, bufBoundaryInBytes, 1);

    // rpRectInMain1ImgBuf = createImageBufferFromFile(p1RectIn1_param, sRect1Filename, "RectIn1", eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN | eBUFFER_USAGE_SW_WRITE_RARELY);
    // rpRectInMain2ImgBuf = createImageBufferFromFile(p1RectIn2_param, sRect2Filename, "RectIn2", eBUFFER_USAGE_HW_CAMERA_READWRITE | eBUFFER_USAGE_SW_READ_OFTEN | eBUFFER_USAGE_SW_WRITE_RARELY);

    rpRectInMain1ImgBuf = createEmptyImageBuffer(p1RectIn1_param, "RectIn1", eBUFFER_USAGE_HW_CAMERA_READWRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_OFTEN);
    rpRectInMain2ImgBuf = createEmptyImageBuffer(p1RectIn2_param, "RectIn2", eBUFFER_USAGE_HW_CAMERA_READWRITE|eBUFFER_USAGE_SW_READ_OFTEN|eBUFFER_USAGE_SW_WRITE_OFTEN);
}
...
{
    sp<IImageBuffer> buf_rsyuv_Main1, buf_rsyuv_Main2;
    sp<IImageBuffer> buf_rect1, buf_rect2;
    loadFullResizRawsImgBuf(buf_rsyuv_Main1, buf_rsyuv_Main2, buf_rect1, buf_rect2);
    // prepare input frame info: RSRAW1
    pRequest->pushRequestImageBuffer({BID_P2A_IN_YUV1, eBUFFER_IOTYPE_INPUT}, buf_rsyuv_Main1);
    // prepare input frame info: RSRAW2
    pRequest->pushRequestImageBuffer({BID_P2A_IN_YUV2, eBUFFER_IOTYPE_INPUT}, buf_rsyuv_Main2);
    // prepare main1 rect yuv
    pRequest->pushRequestImageBuffer({BID_P1_OUT_RECT_IN1, eBUFFER_IOTYPE_INPUT}, buf_rect1);
    // prepare main2 rect yuv
    pRequest->pushRequestImageBuffer({BID_P1_OUT_RECT_IN2, eBUFFER_IOTYPE_INPUT}, buf_rect2);
