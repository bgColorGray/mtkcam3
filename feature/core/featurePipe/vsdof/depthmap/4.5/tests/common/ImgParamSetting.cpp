...
ImgParam getImgParam_RSSOR2Main1(ENUM_STEREO_SCENARIO scenario)
{
    MSize P1YUV_SIZE = gpSizePrvder->getBufferSize(E_RECT_IN_M, scenario);
    MUINT32 MAINIMG_STRIDES[3] = {(MUINT32)P1YUV_SIZE.w, 0, 0};

    return ImgParam(eImgFmt_Y8, P1YUV_SIZE, MAINIMG_STRIDES, FULL_RAW_BOUNDARY, 1);
}

ImgParam getImgParam_RSSOR2Main2(ENUM_STEREO_SCENARIO scenario)
{
    MSize P1YUV_SIZE = gpSizePrvder->getBufferSize(E_RECT_IN_S, scenario);
    MUINT32 MAINIMG_STRIDES[3] = {(MUINT32)P1YUV_SIZE.w, 0, 0};
