...
#define TEST_INPUT_TYPE eDEPTH_INPUT_IMG_2YUVO_2RSSOR2
#define TEST_REQ_TYPE eSTATE_RECORD
#define TEST_NORMAL_SCENARIO eSTEREO_SCENARIO_RECORD
#define TEST_FEATURE_MODE eDEPTHNODE_MODE_VSDOF
#define EIS_ON 0
#define REQUEST_NEED_FEFM 0
#define TEST_REQ_SIZE 1
#define TEST_DEPTH_DELAY 0
...
TEST(DepthMapPipe_Test, Standard)
{
    ...
    // set PipeOption
    sp<DepthMapPipeOption> pPipeOption = new DepthMapPipeOption(moduleType, TEST_FEATURE_MODE, eDEPTH_FLOW_TYPE_QUEUED_DEPTH);
    pPipeOption->mFlowType = (TEST_DEPTH_DELAY == 0) ?
                              eDEPTH_FLOW_TYPE_STANDARD : eDEPTH_FLOW_TYPE_QUEUED_DEPTH;
    pPipeOption->mStereoScenario = TEST_NORMAL_SCENARIO;
    pPipeOption->mInputImg       = TEST_INPUT_TYPE;
    // set PipeSetting
