...
public:
    ...
    struct P2ABufferSize : public BaseBufferSize
    {
        ...
        // size
        MSize mFD_IMG_SIZE;
        StereoArea mFEB_INPUT_SIZE_MAIN1_NONSLANT;
        StereoArea mFEB_INPUT_SIZE_MAIN1;
        StereoArea mFEB_INPUT_SIZE_MAIN2;
        ...
        MSize mMAIN1_YUVO_SIZE;
        MSize mMAIN2_YUVO_SIZE;
        MSize mMAIN2_RRZO_SIZE;
        MSize mMAIN1_RSSOR2_SIZE;
        MSize mRECT_OUT1_SIZE;
        MUINT32 mMAIN2_RRZO_STRIDE = 0;
        MUINT32 mMAIN1_YUVO_STRIDE = 0;
        MUINT32 mMAIN2_YUVO_STRIDE = 0;
        MUINT32 mMAIN1_RSSOR2_STRIDE = 0;
        // crop info
    ...
    struct DVSBufferSize : public BaseBufferSize
    {
        DVSBufferSize() {}
        DVSBufferSize(ENUM_STEREO_SCENARIO scenario)
        : BaseBufferSize(scenario) {};
        //
        MVOID debug() const;
        // size
        ...
        MSize mCFM_SIZE;
        MSize mNOC_SIZE;
        MSize mCFM_NONSLANT_SIZE;
        MSize mNOC_NONSLANT_SIZE;
    };

    struct DVPBufferSize : public BaseBufferSize
    {
        DVPBufferSize() {}
        DVPBufferSize(ENUM_STEREO_SCENARIO scenario)
        : BaseBufferSize(scenario) {};
        //
        MVOID debug() const;
        // size
    ...
    struct DLDepthBufferSize : public BaseBufferSize
    {
        DLDepthBufferSize() {};
        DLDepthBufferSize(ENUM_STEREO_SCENARIO scenario)
        : BaseBufferSize(scenario) {};
        //
        MVOID debug() const;
        //
        MSize mDLDEPTH_SIZE;
        MSize mDLDEPTH_SIZE_NONSLANT;
    };
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:
    ...
    virtual const DVSBufferSize& getDVS(ENUM_STEREO_SCENARIO scen) = 0;
    virtual const DVPBufferSize& getDVP(ENUM_STEREO_SCENARIO scen) = 0;
    virtual const GFBufferSize& getGF(ENUM_STEREO_SCENARIO scen) = 0;
    virtual const DLDepthBufferSize& getDLDepth(ENUM_STEREO_SCENARIO scen) = 0;
