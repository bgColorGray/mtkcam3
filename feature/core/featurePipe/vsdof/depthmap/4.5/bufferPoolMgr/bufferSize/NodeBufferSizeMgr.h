...
typedef BaseBufferSizeMgr::DVSBufferSize DVSBufferSize;
typedef BaseBufferSizeMgr::DVPBufferSize DVPBufferSize;
...
public:
    ...
    struct NodeDVSBufferSize : public DVSBufferSize
    {
        NodeDVSBufferSize(){};
        NodeDVSBufferSize(ENUM_STEREO_SCENARIO scenario);
    };

    struct NodeDVPBufferSize : public DVPBufferSize
    {
        NodeDVPBufferSize(){};
    ...
    struct NodeDLDepthBufferSize : public DLDepthBufferSize
    {
        NodeDLDepthBufferSize(){};
...
public:
    ...
    virtual const DVSBufferSize& getDVS(ENUM_STEREO_SCENARIO scen) {return mDVSSize.valueFor(scen);}
    virtual const DVPBufferSize& getDVP(ENUM_STEREO_SCENARIO scen) {return mDVPSize.valueFor(scen);}
    virtual const GFBufferSize& getGF(ENUM_STEREO_SCENARIO scen) {return mGFSize.valueFor(scen);}
    virtual const DLDepthBufferSize& getDLDepth(ENUM_STEREO_SCENARIO scen) {return mDLDepthSize.valueFor(scen);}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
public:
    ...
    KeyedVector<ENUM_STEREO_SCENARIO, NodeDVSBufferSize> mDVSSize;
    KeyedVector<ENUM_STEREO_SCENARIO, NodeDVPBufferSize> mDVPSize;
    KeyedVector<ENUM_STEREO_SCENARIO, NodeGFBufferSize> mGFSize;
    KeyedVector<ENUM_STEREO_SCENARIO, NodeDLDepthBufferSize> mDLDepthSize;
};
