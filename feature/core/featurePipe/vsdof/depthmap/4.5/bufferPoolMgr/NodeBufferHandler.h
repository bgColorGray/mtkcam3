...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    NodeBufferHandler(sp<BaseBufferPoolMgr> pPoopMgr, DepthMapFlowType flowtype);
...
public:
    ...
    virtual IMetadata* requestMetadata(
                                DepthMapPipeNodeID srcNodeID,
                                DepthMapBufferID bufferID,
                                METADATA_SOURCE dataSource = USE_FLOW_DEFINED);
...
private:
    ...
    IMetadata* mapMetaBIDIntoInternal(DepthMapBufferID BID);
