...
private:
    ...
    /**
     * @brief handle function for notifying buffer is used.
     * @param [in] request DepthMapPipe effect request
     * @return
     * - MTRUE indicates success.
     * - MFALSE indicates failure.
     */
    MBOOL onHandleBufReleased(DepthMapRequestPtr request);
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
