...
public:
    ...
    ADD_TIMER(Overall);
    ADD_TIMER(P2A);
    ADD_TIMER(P2AMdpRectIn2);
    ADD_TIMER(P2AMdp);
    ADD_TIMER(P2ADrv);
    ADD_TIMER(P2ASetIsp);
    ADD_TIMER(P2AMYSResize);
    ADD_TIMER(P2AN3DWaiting);
    ADD_TIMER(P2ABayer);
    ADD_TIMER(P2ABayerSetIsp);
    ADD_TIMER(P2ABayerDrv);
    ADD_TIMER(P2ABayerMdp);
    ADD_TIMER(P2ABayerWPEWaiting);
    ADD_TIMER(P2ABayerPrevReqWaiting);
    ADD_TIMER(N3D);
    ADD_TIMER(N3DMdp);
    ADD_TIMER(N3DPhase1);
    ADD_TIMER(N3DMain1Padding);
    ADD_TIMER(N3DMaskWarping);
    ADD_TIMER(N3DGpuWarping);
    ...
    ADD_TIMER(Slant);
    ADD_TIMER(SlantAlgoNOC);
    ADD_TIMER(SlantAlgoCFM);
    ADD_TIMER(SlantAlgoDepth);
    /**
     ...
     */
    MVOID showPerFrameSummary(MUINT32 requestNo,
                            const EffectRequestAttrs& atr,
                            const sp<DepthMapPipeOption> pPipeOption);

    MVOID showTotalSummary(MUINT32 requestNo,
                            const EffectRequestAttrs& atr,
                            const sp<DepthMapPipeOption> pPipeOption);
