...
android::sp<ImageBufferPool> ImageBufferPool::create(const char *name, const MSize &size, EImageFormat format, MUINT32 usage, MBOOL singleBuffer, const std::vector<MUINT32> &strideHint)
{
  TRACE_FUNC_ENTER();
  (void)strideHint;
...
P2F::ImageInfo ImageBufferPool::getImageInfo() const
{
  TRACE_FUNC_ENTER();
  TRACE_FUNC_EXIT();
  return mImageInfo;
