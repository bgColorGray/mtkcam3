...
public:
  static android::sp<GraphicBufferPool> create(const char *name, MUINT32 width, MUINT32 height, android_pixel_format_t format, MUINT32 usage, NativeBufferWrapper::ColorSpace color = NativeBufferWrapper::NOT_SET, const std::vector<MUINT32> &strideHint = std::vector<MUINT32>());
  static android::sp<GraphicBufferPool> create(const char *name, const MSize &size, EImageFormat format, MUINT32 usage, NativeBufferWrapper::ColorSpace color = NativeBufferWrapper::NOT_SET, const std::vector<MUINT32> &strideHint = std::vector<MUINT32>());
