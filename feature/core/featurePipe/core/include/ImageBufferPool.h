...
public:
  ...
  static android::sp<ImageBufferPool> create(const char* name, const MSize &size, EImageFormat format, MUINT32 usage, MBOOL singleBuffer = MTRUE, const std::vector<MUINT32> &strideHint = std::vector<MUINT32>());
