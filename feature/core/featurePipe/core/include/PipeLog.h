...
#endif
//#ifndef PIPE_ULOG_TAG
//    #warning "Not define PIPE_ULOG_TAG before include PipeLog.h"
//#endif
...
#undef FP_LOG
#ifdef PIPE_ULOG_TAG
    #define FP_LOG(lv, fmt, arg...) CAM_ULOG##lv(PIPE_ULOG_TAG, "[%s]" fmt, __FUNCTION__, ##arg)
#else
...
#define MY_N_LOGV(n, fmt, arg...)        FP_DO(FP_LOG(V, "[%s]" fmt, n, ##arg))
#define MY_N_LOGD(n, fmt, arg...)        FP_DO(FP_LOG(D, "[%s]" fmt, n, ##arg))
#define MY_N_LOGI(n, fmt, arg...)        FP_DO(FP_LOG(I, "[%s]" fmt, n, ##arg))
#define MY_N_LOGW(n, fmt, arg...)        FP_DO(FP_LOG(W, "[%s]" fmt, n, ##arg))
#define MY_N_LOGE(n, fmt, arg...)        FP_DO(FP_LOG(E, "[%s]" fmt, n, ##arg))
#define MY_N_LOGA(n, fmt, arg...)        FP_DO(FP_LOG(A, "[%s]" fmt, n, ##arg))

#define MY_SN_LOGV(s, n, fmt, arg...)    MY_S_LOGV(s, "[%s]" fmt, n, ##arg)
#define MY_SN_LOGD(s, n, fmt, arg...)    MY_S_LOGD(s, "[%s]" fmt, n, ##arg)
#define MY_SN_LOGI(s, n, fmt, arg...)    MY_S_LOGI(s, "[%s]" fmt, n, ##arg)
#define MY_SN_LOGW(s, n, fmt, arg...)    MY_S_LOGW(s, "[%s]" fmt, n, ##arg)
#define MY_SN_LOGE(s, n, fmt, arg...)    MY_S_LOGE(s, "[%s]" fmt, n, ##arg)
#define MY_SN_LOGA(s, n, fmt, arg...)    MY_S_LOGA(s, "[%s]" fmt, n, ##arg)
