...
# The pyramid size that MFLL supports
MFLL_PYRAMID_SIZE                       := 0
...
# MT6761
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6761))
...
# MT6797
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6797))
...
# MT6757
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6757))
...
# MT6799
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6799))
...
# MT6763
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6763))
...
# MT6758
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6758))
...
# MT6771
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6771))
...
# MT6775
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6775))
...
# MT6765
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6765))
...
# MT6768
# {{{
ifeq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6768))
...
# MT6779
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),11)
  MFLL_PLATFORM                 := $(MTKCAM_TARGET_BOARD_PLATFORM)
  MFLL_ALGO_FEATURE_DECOUPLING  := 1
...
# MT6885
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),14)
  MFLL_PLATFORM                 := $(call to-lower,$(MTKCAM_PLATFORM))
  MFLL_ALGO_FEATURE_DECOUPLING  := 1

  MFLL_MF_TAG_VERSION           := 14
  MFLL_MF_TAG_SUBVERSION        := 1

  MFLL_CORE_VERSION_MAJOR       := 4
  MFLL_CORE_VERSION_MINOR       := 0

  MFLL_MODULE_VERSION_BSS       := default
  MFLL_MODULE_VERSION_CAPTURER  := 1.3
  MFLL_MODULE_VERSION_EXIFINFO  := 1.0
  MFLL_MODULE_VERSION_PERFSERV  := default
  MFLL_MODULE_VERSION_IMAGEBUF  := 1.1
  MFLL_MODULE_VERSION_MEMC      := 1.3
  MFLL_MODULE_VERSION_MFB       := 4.0
  MFLL_MODULE_VERSION_NVRAM     := 2.1
  MFLL_MODULE_VERSION_STRATEGY  := 1.5
...
# MT6873
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),15)
  MFLL_PLATFORM                 := $(MTKCAM_TARGET_BOARD_PLATFORM)
  MFLL_ALGO_FEATURE_DECOUPLING  := 1

  MFLL_MF_TAG_VERSION           := 15
  MFLL_MF_TAG_SUBVERSION        := 0
...
# MT6853
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),16)
  MFLL_PLATFORM                 := $(call to-lower,$(MTKCAM_PLATFORM))
  MFLL_ALGO_FEATURE_DECOUPLING  := 1

  MFLL_MF_TAG_VERSION           := 16
  MFLL_MF_TAG_SUBVERSION        := 0
...
# MT6877
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),17)
  MFLL_PLATFORM                 := $(call to-lower,$(MTKCAM_TARGET_BOARD_PLATFORM))
  MFLL_ALGO_FEATURE_DECOUPLING  := 1

  MFLL_MF_TAG_VERSION           := 17
  MFLL_MF_TAG_SUBVERSION        := 0
...
# MT6781
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),19)
  MFLL_PLATFORM                 := $(call to-lower,$(MTKCAM_TARGET_BOARD_PLATFORM))
  MFLL_ALGO_FEATURE_DECOUPLING  := 1

  MFLL_MF_TAG_VERSION           := 19
  MFLL_MF_TAG_SUBVERSION        := 0
...
# MT6781
# {{{
ifeq ($(MTKCAM_OPT_MFLL_MF_TAG_VERSION),20)
  MFLL_PLATFORM                 := $(call to-lower,$(MTKCAM_TARGET_BOARD_PLATFORM))
  MFLL_ALGO_FEATURE_DECOUPLING  := 1

  MFLL_MF_TAG_VERSION           := 20
  MFLL_MF_TAG_SUBVERSION        := 0
...
ifeq ($(strip $(MFLL_ALGO_FEATURE_DECOUPLING)),1)
  ...
  ifneq ($(MTKCAM_TARGET_BOARD_PLATFORM), $(filter $(MTKCAM_TARGET_BOARD_PLATFORM), mt6761))
...
ifeq ($(strip $(MFLL_NVRAM_3A_TUNING_COUPLING)),1)
  MFLL_INCLUDE_PATH += $(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/aaa
  MFLL_INCLUDE_PATH += $(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning
endif
...
MFLL_SHARED_LIBS += libmtkcam_tuning_utils
...
ifeq ($(strip $(MFLL_MODULE_VERSION_CAPTURER)),1.3)
  # no need any
endif
...
ifeq ($(strip $(MFLL_MODULE_VERSION_MFB)),4.0)
  MFLL_SHARED_LIBS += libcam.iopipe
  MFLL_SHARED_LIBS += libmtkcam_metadata
  MFLL_SHARED_LIBS += libmtkcam_imgbuf
  MFLL_SHARED_LIBS += libmtkcam_modulehelper
...
# HEADER LIBS
MFLL_HEADER_LIBRARIES   := libmtkcam_headers
MFLL_HEADER_LIBRARIES   += libmtkcam3_headers
MFLL_HEADER_LIBRARIES   += libhardware_headers
MFLL_HEADER_LIBRARIES   += libcameracustom_headers
MFLL_HEADER_LIBRARIES   += libladder_headers
MFLL_HEADER_LIBRARIES   += libutils_headers
#MFLL_HEADER_SHARED_LIB  :=
...
MFLL_CFLAGS += -DMFLL_PYRAMID_SIZE=$(MFLL_PYRAMID_SIZE)
...
MFLL_CFLAGS += -DMFLL_PLATFORM_$(call to-upper,$(MFLL_PLATFORM))
