...
const pthread_attr_t PTHREAD_DEFAULT_ATTR = {
    0, NULL, 1024 * 1024, 4096, SCHED_OTHER, ANDROID_PRIORITY_FOREGROUND, {0}
};
 ...
 */
enum MfllErr MfllCore::doCapture(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
...
enum MfllErr MfllCore::doBss(void *void_frameCount)
{
    ...
    if (m_bypass.bypassBss || status.ignore || (bssFrameCount <= 0)) {
        ...
        for (size_t i = 0; i < bssFrameCount; i++) {
            ...
            m_bssIndex[i] = index;
            mfllLogD("%s: new index (%zu)-->(%d)", __FUNCTION__, i, index);
            /**
        ...
        if (frameNumToSkip > 0) {
            ...
            for (size_t i = getCaptureFrameNum() - frameNumToSkip; i < getCaptureFrameNum(); i++) {
                mfllLogD("%s: skip frame index = %zu", __FUNCTION__, i);
 ...
 *  2. BSS has been done
 */
enum MfllErr MfllCore::doEncodeYuvBase(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
 ...
 *  2. BSS has been done
 */
enum MfllErr MfllCore::doEncodeYuvGolden(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
 ...
 */
enum MfllErr MfllCore::doMixing(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
...
enum MfllErr MfllCore::doAllocYuvBase(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
...
enum MfllErr MfllCore::doAllocYuvGolden(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
...
enum MfllErr MfllCore::doAllocYuvWorking(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
 ...
 */
enum MfllErr MfllCore::doAllocYuvMcWorking(void */*__arg*/)
{
    enum MfllErr err = MfllErr_Ok;
    MfllEventStatus_t status;
...
enum MfllErr MfllCore::joinThread(pthread_t *pThread)
{
    ...
    if (r == EINVAL) {
        mfllLogE("Join pthread %ld failed, perhaps it's not a joinable thread", (*pThread));
        err = MfllErr_UnexpectedError;
    }
    mfllFunctionOut();
    return err;
