...
public:
    ...
    enum MfllErr doCapture(void *__arg);
    ...
    enum MfllErr doEncodeYuvBase(void *__arg);
    enum MfllErr doEncodeYuvGolden(void *__arg);
    ...
    enum MfllErr doMixing(void *__arg);
    enum MfllErr doNoiseReduction(void *__arg);
    enum MfllErr doCreatePostview(void *__arg);
    enum MfllErr doEncodeThumbnail(void *__arg);
    enum MfllErr doEncodeJpeg(void *__arg);

/* Buffer allocations */
    enum MfllErr doAllocRawBuffer(void *void_index);
    enum MfllErr doAllocQyuvBuffer(void *void_index);
    enum MfllErr doAllocYuvBase(void *__arg);
    enum MfllErr doAllocYuvGolden(void *__arg);
    enum MfllErr doAllocYuvWorking(void *__arg);
    enum MfllErr doAllocYuvMcWorking(void *__arg);
