...
AINR_MODULE_VERSION_BUFPOOL             := 1.0
...
# MT6779
# {{{
ifeq ($(MTKCAM_OPT_AINR_VERSION),1.0)
  AINR_PLATFORM                 := $(MTKCAM_TARGET_BOARD_PLATFORM)
...
# MT6885 MT6893
# {{{
ifeq ($(MTKCAM_OPT_AINR_VERSION),2.0)
  AINR_PLATFORM                 := $(MTKCAM_TARGET_BOARD_PLATFORM)
  AINR_ALGO_FEATURE_DECOUPLING  := 1
...
AINR_SHARED_LIBS += libmtkcam_scenariorecorder
# Thermal
...
AINR_LIB_NAME_POOL      := libworkingbufpool
#------------------------------------------------------------------------------
# defines
#------------------------------------------------------------------------------
AINR_CFLAGS :=
...
AINR_CFLAGS += -DAINR_PLATFORM_$(call to-upper,$(AINR_PLATFORM))
