...
ifeq ($(MTKCAM_OPT_MFLL_APPLY_RAW_BSS),yes)
...
BSSCORE_INCLUDE_PATH += $(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc
BSSCORE_INCLUDE_PATH += $(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning
BSSCORE_INCLUDE_PATH += $(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/isp_tuning/$(MTK_CAM_SW_VERSION)
BSSCORE_INCLUDE_PATH += $(MTKCAM_PATH_CUSTOM_PLATFORM)/hal/inc/aaa
BSSCORE_INCLUDE_PATH += $(TOP)/$(MTKCAM_PATH_CUSTOM_PLATFORM)
...
#for libawb_core_lib
BSSCORE_INCLUDE_PATH += $(MTK_PATH_SOURCE)/hardware/libcamera_3a/libawb_core_lib/$(MTKCAM_TARGET_BOARD_PLATFORM)/include

#for libae_core_lib
BSSCORE_INCLUDE_PATH += $(MTK_PATH_SOURCE)/hardware/libcamera_3a/libae_core_lib/$(MTKCAM_TARGET_BOARD_PLATFORM)/include
BSSCORE_INCLUDE_PATH += $(MTK_PATH_SOURCE)/hardware/libcamera_3a/libae_core_lib/$(MTKCAM_TARGET_BOARD_PLATFORM)/include/aaa

#for libaf_core_lib
BSSCORE_INCLUDE_PATH += $(MTK_PATH_SOURCE)/hardware/libcamera_3a/libaf_core_lib/$(MTKCAM_TARGET_BOARD_PLATFORM)/include

#for libflash_lib
BSSCORE_INCLUDE_PATH += $(MTK_PATH_SOURCE)/hardware/libcamera_3a/libflash_lib/$(MTKCAM_TARGET_BOARD_PLATFORM)/include
...
BSSCORE_SHARED_LIBS += libmtkcam_scenariorecorder
...
# Tuning
ifeq ($(MTKCAM_OPT_MAPPING_MGR),yes)
