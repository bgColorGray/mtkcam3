...
#undef  P1NODE_SUPPORT_CONFIRM_BUF_VA
#define P1NODE_SUPPORT_CONFIRM_BUF_VA (1)
...
#undef  P1NODE_USING_DRV_SET_RSS_R2_CBFP_EXP_SKIP
#define P1NODE_USING_DRV_SET_RSS_R2_CBFP_EXP_SKIP (1)
#undef  P1NODE_USING_DRV_SET_YUV_CBFP_EXP_SKIP
#define P1NODE_USING_DRV_SET_YUV_CBFP_EXP_SKIP (1)
