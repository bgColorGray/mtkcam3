 ...
 *
 ******************************************************************************/
class P1NotifyYuvoCrop
    : public P1_TUNING_NOTIFY
{

public:
    P1NotifyYuvoCrop(sp<P1RegisterNotify> spP1Notify)
        : mspP1Notify(spP1Notify)
    {};

    virtual ~P1NotifyYuvoCrop()
    {};

    virtual const char* TuningName()
    { return "P1NodeYuvoCrop"; };
 ...
 *
 ******************************************************************************/
class P1NotifyRssR2Crop
    : public P1_TUNING_NOTIFY
{
public:
    P1NotifyRssR2Crop(sp<P1RegisterNotify> spP1Notify)
        : mspP1Notify(spP1Notify)
    {};

    virtual ~P1NotifyRssR2Crop()
    {};

    virtual const char* TuningName()
    { return "P1NotifyRssR2Crop"; };
