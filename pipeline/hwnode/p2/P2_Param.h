...
#define ENUM_ID_IMG(idx)    \
    ...
    IN_Tracking_YUV_##idx

#define ENUM_ID_STREAM(idx)    \
    IN_S_OPAQUE_##idx,         \
    IN_S_SEAMLESS_FULL_##idx,  \
    IN_S_FULL_##idx,           \
    IN_S_RESIZED_##idx,        \
    IN_S_P1STT_##idx,          \
    IN_S_RSSO_##idx,           \
...
public:
    ...
    NSCam::EImageFormat getImgFormat() const;
...
private:
    ...
    MVOID dumpNddBuffer(IImageBuffer *buffer, unsigned index) const;
