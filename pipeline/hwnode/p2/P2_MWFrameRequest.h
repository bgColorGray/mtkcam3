...
private:
    ...
    MVOID updateP2PackMaster(MUINT32 masterId);
    MVOID updateP2FrameData(MUINT32 masterId);
    MVOID updateP2SensorData();
    MVOID updateP1TS(const sp<P2Meta> &p1App, const sp<P2Meta> &p1Hal, P2SensorData &data);
    MVOID updateISO(const sp<P2Meta> &inApp, const sp<P2Meta> &p1App, const sp<P2Meta> &p1Hal, P2SensorData &data);
