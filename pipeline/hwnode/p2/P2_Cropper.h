...
public:
    ...
    MBOOL getMatrix(const MPoint& offset, const MSize& from, const MSize& to, HwMatrix* mat) const;
...
private:
    ...
    // Physical Output Used
    MRect mPhysicalAppCrop;
    MRect mPhySensorCrop;
    MRect mPhyResizedCrop;
