...
private:
    ...
    static MUINT32 refineBufferUsage(const sp<IImageBuffer>& buf, MUINT32 usage, MBOOL needSWRW);
...
private:
    ...
    MBOOL mIsEarlyDispatched = MFALSE;
    MBOOL mNeedRefineBufferUsage = MFALSE;
};
