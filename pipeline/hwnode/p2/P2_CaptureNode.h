...
private:
    ...
    MINT32 getReadyFrameCountOrPushToList(sp<IPipelineFrame> pFrame);
    sp<IPipelineFrame> getFrameFromList();
...
private:
    ...
    MINT32          mFrameCount;
    MINT32          mCurFrameIndex;
    std::list<std::pair<MUINT32, sp<IPipelineFrame>>>  mlPipelineFrame; // <index, IPipelineFrame>
