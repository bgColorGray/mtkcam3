...
inline MPointF inv_transform(simpleTransform const& trans, MPointF const& p) {
    return MPointF(
            ( ( p.x * trans.oldScale.w / trans.newScale.w) + trans.tarOrigin.x),
            ( ( p.y * trans.oldScale.h / trans.newScale.h) + trans.tarOrigin.y)
            );
};
...
inline MSizeF inv_transform(simpleTransform const& trans, MSizeF const& s) {
    return MSizeF(
            ( s.w * trans.oldScale.w / trans.newScale.w),
            ( s.h * trans.oldScale.h / trans.newScale.h)
            );
};
// transform MRect
...
inline MRectF inv_transform(simpleTransform const& trans, MRectF const& r) {
    return MRectF(inv_transform(trans, r.p), inv_transform(trans, r.s));
};
/******************************************************************************
 *  Metadata Access
 ******************************************************************************/
