...
LOCAL_CFLAGS += -DSUPPORT_VPU
endif
################################################################################
ifeq ($(MTKCAM_OPT_REDUCE_GRALLOC_VA), yes)
LOCAL_CFLAGS += -DSUPPORT_OPT_NONEED_GRALLOC_VA
endif
################################################################################
...
LOCAL_CFLAGS += -DMTKCAM_JPEG_ASYNC_WAIT_ENCODE_REQ

#-----------------------------------------------------------
LOCAL_SRC_FILES += DummyNode.cpp
LOCAL_SRC_FILES += BaseNode.cpp
LOCAL_SRC_FILES += p1/P1NodeImageSteramInfo.cpp
...
LOCAL_SRC_FILES += p2/P2_Streaming_Draw.cpp
...
#-----------------------------------------------------------
# MPEG4 writer
ifneq ($(MTK_CAM_LAZY_HAL), yes)
LOCAL_CFLAGS += -DMTKCAM_ISP_HIDL_HEIF
