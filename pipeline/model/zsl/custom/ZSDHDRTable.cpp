 ...
 *
 ******************************************************************************/
void ZSDHDRSelector::initRequestTable() const
{
...
ZSDHDR_REQUEST_MAPPING_TABLE_BEGIN()
    ADD_ITEM_BEGIN(Zsl_Mode, MTK_FEATURE_VHDR_STATUS_2EXP)
    ...
    ADD_ITEM_BEGIN(Zsl_Mode, MTK_FEATURE_VHDR_STATUS_3EXP)
        ADD_REQUEST_ZSL_HISTORY(MTK_STAGGER_IMGO_NE, 0)
    ...
    ADD_ITEM_BEGIN(Zsl_NonZsl_Mode, MTK_FEATURE_VHDR_STATUS_2EXP)
    ...
    ADD_ITEM_BEGIN(Zsl_NonZsl_Mode, MTK_FEATURE_VHDR_STATUS_3EXP)
        ADD_REQUEST_ZSL_INFLIGHT(MTK_STAGGER_IMGO_NE, 0)
        ADD_REQUEST_ZSL_INFLIGHT(MTK_STAGGER_IMGO_SE, 0)
        ADD_REQUEST_ZSL_INFLIGHT(MTK_STAGGER_IMGO_NE, 1)
        ADD_REQUEST_ZSL_INFLIGHT(MTK_STAGGER_IMGO_SE, 1)
