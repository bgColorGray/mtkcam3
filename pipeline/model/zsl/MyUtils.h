...
#ifndef _MTK_HARDWARE_MTKCAM3_PIPELINE_MODEL_ZSL_MYUTILS_H_
#define _MTK_HARDWARE_MTKCAM3_PIPELINE_MODEL_ZSL_MYUTILS_H_
...
#ifndef CONTINUE_IF_NULLPTR
#define CONTINUE_IF_NULLPTR(_expr_, ...)                                \
    if (1) {                                                            \
...
#ifndef ASSERT_IF_NULLPTR
#define ASSERT_IF_NULLPTR(_expr_, ...)                                  \
    do {                                                                \
        if( CC_UNLIKELY((_expr_)==nullptr) ) {                          \
            MY_LOGA(__VA_ARGS__);                                       \
            return;                                                     \
 ...
 *
 ******************************************************************************/
#endif  //_MTK_HARDWARE_MTKCAM3_PIPELINE_MODEL_ZSL_MYUTILS_H_
