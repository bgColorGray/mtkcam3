...
public:
    ...
    virtual auto    setP1Imgo_Default(
                        size_t maxBufNum,
                        P1HwSetting const& rP1HwSetting,
                        bool isSeamlessSwitchImgo = false
                    ) -> P1ImageStreamInfoBuilder&;

    virtual auto    setP1SeamlessImgo_Default(
                        P1HwSetting const& rP1HwSetting
                    ) -> P1ImageStreamInfoBuilder&;

    virtual auto    setP1Imgo_Stagger(
                        P1HwSetting const& rP1HwSetting,
                        MINT batchNum
                    ) -> P1ImageStreamInfoBuilder&;
...
public:
    ...
    virtual auto    setPluginQueryParam(void *param) -> void;

private:
    void   *mPluginQueryParam = NULL;
