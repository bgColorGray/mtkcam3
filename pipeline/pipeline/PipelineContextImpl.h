 ...
 *  Definitions.
 ******************************************************************************/
class PipelineContextBuilderImpl;
...
public:     ////    Operations
    auto            updateConfig(PipelineContextBuilderImpl const* pBuilder) -> int;
...
public:     ////    Operations
    ...
    virtual auto    flushNodeByNodeId(NodeId_T const nodeId) -> int;
