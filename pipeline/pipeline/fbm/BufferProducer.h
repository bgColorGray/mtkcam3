...
public:   //// operations.
    ...
    virtual auto    setMinInitBufferCount(size_t count) -> void;
    ...
    auto shareSB(android::sp<IImageStreamBuffer> const& src) -> android::sp<IImageStreamBuffer>;
...
protected:
    ...
    bool                            mbInited = false;
    size_t                          mMaxNumberOfBuffers = 0;
    size_t                          mMinNumberOfInitialCommittedBuffers = 0;
...
protected:
    ...
    std::map<IImageStreamBuffer*, android::sp<IImageBufferHeap> >
                                    mBufferMap;
    // multiple SBs can share the same Heap.
    std::map<android::sp<IImageBufferHeap>, std::set<IImageStreamBuffer*>>
                                    mHeapToSbs;
