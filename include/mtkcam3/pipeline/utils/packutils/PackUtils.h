...
public:
    ...
    MERROR packFeoDataToHalMeta_Begin(android::sp<IImageBufferHeap> pInputBufferHeap,IMetadata &appControlMeta, IMetadata &halResultMeta);
    MERROR packFeoDataToHalMeta_End(IMetadata &halResultMeta);
...
protected:
    ...
    sp<IImageBuffer> mFeoBuffer = nullptr;
    sp<IImageBuffer> mRrzoBuffer = nullptr;
    sp<IImageBuffer> mBssRrzoBuffer = nullptr;
    std::shared_ptr<ainr::IAinrFeFm> mFefm;
};
