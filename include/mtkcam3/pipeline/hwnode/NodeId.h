...
enum
{
    ...
    //
    eNODEID_FDNode_NUM      = 3,
    eNODEID_FDNode_BEGIN    = 0x16,
    eNODEID_FDNode          = eNODEID_FDNode_BEGIN,
    eNODEID_FDNode_END      = eNODEID_FDNode_BEGIN + eNODEID_FDNode_NUM,
    //
    ...
    // Just used on ISP6S
    eNODEID_AIAWB_NUM       = 3,
    eNODEID_AIAWB_BEGIN     = 0x100,
    eNODEID_AIAWB_END       = eNODEID_AIAWB_BEGIN + eNODEID_AIAWB_NUM,
};
...
public:
    ...
    /**
     * Get the node Id of FDNode.
     *
     * @param index The index of physical sensors, starting from 0.
     *
     * @return The node Id.
     */
    static constexpr NodeId_T getFDNodeId(size_t index)
    {
        auto const id = eNODEID_FDNode_BEGIN + index;
        if (CC_LIKELY(  eNODEID_FDNode_END > id  )) {
            return id;
        }
        return eNODEID_UNKNOWN;
    }
    ...
    /**
     * Get the node Id of AIAWB.
     *
     * @param index The index of physical sensors, starting from 0.
     *
     * @return The node Id.
     */
    static constexpr NodeId_T getAIAWBNodeId(size_t index) {
        auto const id = eNODEID_AIAWB_BEGIN + index;
        if (CC_LIKELY(  eNODEID_AIAWB_END > id )) {
            return id;
        }
        return eNODEID_UNKNOWN;
    }
