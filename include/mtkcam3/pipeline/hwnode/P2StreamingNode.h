...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
        ...
        /**
         * A pointer to a full-size raw input image stream info. (seanless switch)
         */
        android::Vector<android::sp<IImageStreamInfo>> pvInSeamlessFullRaw;
        ...
        /**
         * A pointer to a rss r2 raw input image stream info.
         */
        android::sp<IImageStreamInfo> pInRssoR2Raw;
        ...
        /**
         * A pointer to App Depth image stream info.
         */
        android::sp<IImageStreamInfo> pOutAppDepthImage;
        ...
        /**
         * A pointer to Tracking YUV image stream info.
         */
        android::sp<IImageStreamInfo> pInTrackingYuv;
        ...
        struct P1SubStreams
        {
             ...
             * A pointer to a rss r2 raw input image stream info.
             */
            android::sp<IImageStreamInfo> pInRssoR2Raw_Sub = NULL;
            /**
             * A pointer to input image stream info. (full-zsl input port)
             */
            ...
            * A pointer to Tracking YUV image stream info.
            */
            android::sp<IImageStreamInfo> pInTrackingYuv_Sub = NULL;
