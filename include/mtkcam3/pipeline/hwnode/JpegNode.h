...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
        ...
        /*
         * A pointer to accept app input yuv stream.
         */
        android::sp<IImageStreamInfo> pInAppYuv_Main = NULL;
        ...
        /*
         * A pointer to internal Hal Jpeg for debug dump usage.
         */
        android::sp<IImageStreamInfo> pOutInternalJpeg = NULL;
