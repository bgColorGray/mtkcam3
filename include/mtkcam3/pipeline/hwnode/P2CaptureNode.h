...
public:     ////                    Definitions.
    ...
    struct  ConfigParams
    {
        ...
        /**
         * A pointer to a full-size raw input image stream info. (seamless switch)
         */
        ...
        /**
         * A pointer to a resized raw or yuv(by platform) input image stream info.
         */
        android::sp<IImageStreamInfo> pInResized;
        ...
        struct P1SubStreams
        {
            ...
            //  A pointer to a resized raw or yuv(by platform) input image stream info.
            android::sp<IImageStreamInfo> pInResizedSub = NULL;
