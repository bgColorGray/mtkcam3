...
struct RequestOutputParams
{
    ...
    std::shared_ptr<TrackFrameResultParams>*    pTrackFrameResultParams = nullptr;
};
...
struct RequestInputParams
{
    ...
    int                                         masterId = 0;
    // Decide which fd node should do face detection
    MINT32                                      targetFd = 0;
    bool                                        isAppRawOutFromP2C = false;
    bool                                        isP1OnlyOutImgo = false;
    bool                                        isZSLMode = false;
    bool                                        isSeamlessRemosaicCapture = false;
    /**************************************************************************
     * Request parameters
     *
     ...
     */
    NodeEdgeSet const*                          pRequest_NodeEdges = nullptr;
     ...
     *
     * The value shows which dma of sensor id are needed.
     * For example,
     ...
     */
    SensorMap<uint32_t> const*                  pRequest_NeedP1Dma = nullptr;
     ...
     * For example,
     *      (needP2P.at(1) & P2_STREAMING) != 0 indicates that P2Streaming is needed for sensorId 1.
     *      (needP2P.at(3) & P2_STREAMING) != 0 indicates that P2Streaming is needed for sensorId 3.
     */
    SensorMap<uint32_t> const*                  pRequest_NeedP2Process = nullptr;
    ...
    /**
     * Multicam related info.
     */
    ParsedMultiCamInfo*      pParsedMultiCamInfo = nullptr;
