 ...
 * For example,
 *      pvP1DmaNeed->at(1) & P1_IMGO != 0 indicates that IMGO is needed for sensor ID 1.
 *      pvP1DmaNeed->at(3) & P1_RRZO != 0 indicates that RRZO is needed for sensor ID 3.
 *
...
{
    SensorMap<ParsedStreamInfo_P1>*     pvOut = nullptr;
    SensorMap<SensorSetting> const*     pvSensorSetting = nullptr;
    SensorMap<P1HwSetting> const*       pvP1HwSetting = nullptr;
    SensorMap<uint32_t> const*          pvP1DmaNeed = nullptr;
