 ...
 *
 ******************************************************************************/
class IPipelineContextBuilder
{
public:     ////    Definitions.
    using IPipelineContextT = android::sp<IPipelineContext>;
    using AttributeT = uint32_t;
...
public:
    virtual         ~IPipelineContextBuilder() = default;
    static  auto    make() -> std::shared_ptr<IPipelineContextBuilder>;

public:     ////    Operations

    /**
     * Set an existing pipeline context.
     */
    virtual auto    setPipelineContext(IPipelineContextT pContext) -> bool      = 0;

    /**
     * Set a set of pool-shared streams.
     */
    ...
    /**
     * Add a meta stream to the builder.
     */
    virtual auto    addStream(ImageStream const& s) -> void                     = 0;

    /**
     * Add an image stream to the builder.
     */
    virtual auto    addStream(MetaStream const& s) -> void                      = 0;

    /**
     * Build all streams.
     */
    virtual auto    buildStreams() -> bool                                      = 0;
...
public:
    ...
    using BatchInfoT            = NSCam::v3::IPipelineFrame::BatchInfo;
...
public:     ////    Access
    ...
    virtual auto    getBatchInfo() const -> BatchInfoT                      = 0;
    virtual auto    setBatchInfo(BatchInfoT const& arg) -> void             = 0;
};
