...
public:     ////    Operations.
     ...
     *
     */
    using requestStreamBuffer_cb = std::function<void(android::sp<IImageStreamBuffer>const& pStreamBuffer)>;
...
public:     ////                Callback.
    ...
    public:
        ...
        struct Result
        {
            ...
            // use to mark reprocess frame or not.
            MBOOL                   bIsReprocessFrame = false;
            MBOOL                   bResultError = false;
        };
