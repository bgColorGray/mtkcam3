...
public:     ////
    ...
    public:
        ...
        virtual auto    getVirtualInstanceId() const -> int32_t { return getDeviceInfo().mVirtualInstanceId; }
...
public:     ////
    ...
    // todo: an interface of CameraDevice3Impl for HidlCameraDevice3 and LegacyModule
    virtual auto    getDeviceInterface(
