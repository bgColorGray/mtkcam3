...
#ifndef INCLUDE_MTKCAM3_MAIN_MTKHAL_ANDROID_DEVICE_3_X_UTILS_AIMAGESTREAMINFO_H_
#define INCLUDE_MTKCAM3_MAIN_MTKHAL_ANDROID_DEVICE_3_X_UTILS_AIMAGESTREAMINFO_H_
//
...
struct AImageStreamInfoBuilder;

/**
 * camera3 image stream info.
 */
class AImageStreamInfo : public IImageStreamInfo {
  friend AImageStreamInfoBuilder;
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
  //  Implementations.
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 public:  ////                    Definitions.
 ...
 public:  ////                    Instantiation.
  explicit AImageStreamInfo(CreationInfo const& info);
  ///< copy constructor
  AImageStreamInfo(AImageStreamInfo const& other,
 ...
 public:  ////                    Attributes.
  ...
  virtual auto toString() const -> String8;
 ...
 */
struct AImageStreamInfoBuilder : public IImageStreamInfoBuilder {
  ::android::sp<AImageStreamInfo> mStreamInfo;
  explicit AImageStreamInfoBuilder(IImageStreamInfo const* info);
...
struct Camera3StreamInfoBuilderFactory : public IStreamInfoBuilderFactory {
  ...
  virtual auto makeImageStreamInfoBuilder(IImageStreamInfo const* info) const
      -> std::shared_ptr<IImageStreamInfoBuilder> {
    return std::make_shared<AImageStreamInfoBuilder>(info);
  }
};
...
#endif  // INCLUDE_MTKCAM3_MAIN_MTKHAL_ANDROID_DEVICE_3_X_UTILS_AIMAGESTREAMINFO_H_
