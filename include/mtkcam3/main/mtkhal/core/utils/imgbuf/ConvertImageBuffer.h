...
#ifndef INCLUDE_MTKCAM_ANDROID_UTILS_IMGBUF_CONVERTIMAGEBUFFER_H_
#define INCLUDE_MTKCAM_ANDROID_UTILS_IMGBUF_CONVERTIMAGEBUFFER_H_
...
#endif  // INCLUDE_MTKCAM_ANDROID_UTILS_IMGBUF_CONVERTIMAGEBUFFER_H_
