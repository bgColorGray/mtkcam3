...
{
    rrz_in_wd = rrz_in_wd ? rrz_in_wd : 1;
    rrz_in_ht = rrz_in_ht ? rrz_in_ht : 1;
...
struct MOTIONNR_IN_PARAMS
{
    NSCam::MSize p2_in;
    NSCam::MSize motion_map;
};

struct MOTIONNR_OUT_PARAMS
{
    _SRZ_SIZE_INFO_ srz4Param;
};

inline void calculateMOTIONNRConfig(MOTIONNR_IN_PARAMS in, MOTIONNR_OUT_PARAMS &out)
{
    out.srz4Param.in_w = in.motion_map.w;
    out.srz4Param.in_h = in.motion_map.h;
    out.srz4Param.crop_floatX = 0;
    out.srz4Param.crop_floatY = 0;
    out.srz4Param.crop_x = 0;
    out.srz4Param.crop_y = 0;
    out.srz4Param.crop_w = in.motion_map.w;
    out.srz4Param.crop_h = in.motion_map.h;
    out.srz4Param.out_w = in.p2_in.w;
    out.srz4Param.out_h = in.p2_in.h;
}
