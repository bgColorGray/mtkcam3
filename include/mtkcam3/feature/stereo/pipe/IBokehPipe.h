...
/**
 * @brief Bokeh scenario
 */
typedef enum eBokehScenario {
    eBOKEH_PREVIEW,
    eBOKEH_RECORD
}BokehScenario;

typedef enum eBokehFlowType {
    eBOKEH_FLOW_TYPE_P2_ONLY,
    eBOKEH_FLOW_TYPE_P2_SW,
    eBOKEH_FLOW_TYPE_P2_SW_MDP,
    eBOKEH_FLOW_TYPE_P2_MDP,
}BokehFlowType;
