...
typedef enum eDepthNodeFeatureMode {
    ...
    eDEPTHNODE_MODE_MTK_UNPROCESS_DEPTH,        // DVS
    eDEPTHNODE_MODE_MTK_SW_OPTIMIZED_DEPTH,     // GF
    eDEPTHNODE_MODE_MTK_HW_HOLEFILLED_DEPTH,    // DVP
    eDEPTHNODE_MODE_MTK_AI_DEPTH,                // AI Depth
...
typedef enum eDepthInputImgCombination
{
    eDEPTH_INPUT_IMG_2RAW,
    eDEPTH_INPUT_IMG_2RAW1RECT,
    eDEPTH_INPUT_IMG_2RRZO_2RSSOR2,
    eDEPTH_INPUT_IMG_2YUVO_2RSSOR2,
    eDEPTH_INPUT_IMG_UNDEFINED
}DepthInputImgCombination;

typedef enum eDepthDebugImg{
    eDEPTH_DEBUG_IMG_NONE,
    eDEPTH_DEBUG_IMG_BLUR_MAP,
    eDEPTH_DEBUG_IMG_DISPARITY,
    eDEPTH_DEBUG_IMG_CONFIDENCE,
    eDEPTH_DEBUG_IMG_NOC,
    eDEPTH_DEBUG_IMG_INVALID
}DepthDebugImg;
/*******************************************************************************
* Struct Definition
********************************************************************************/
...
public:
    ...
    DepthDebugImg mDebugInk = eDEPTH_DEBUG_IMG_NONE;
    StereoHAL::ENUM_STEREO_SCENARIO mStereoScenario = StereoHAL::eSTEREO_SCENARIO_UNKNOWN;        /*!< Indicate the operation mode for Normal state*/
    DepthInputImgCombination mInputImg = eDEPTH_INPUT_IMG_UNDEFINED;
};
