...
// Only needed for slant camera
#define CUSTOM_KEY_SENSOR_OFFSET        "Sensor Offset" // unit: cm
#define CUSTOM_KEY_MODULE_DEGREE        "Module Degree" // unit: degree(0~90)
...
#define CUSTOM_KEY_ENABLE_RECORD        "Enable Record"

#define CUSTOM_KEY_EXCLUSIVES           "Exclusives"

#define CUSTOM_KEY_ISP_PROFILE          "ISP Profile"

#define CUSTOM_KEY_DEPTH_FLOW           "Depth Flow"

#define CUSTOM_KEY_DEPTH_DELAY          "Depth Delay"

#define CUSTOM_KEY_DEPTH_FREQ           "Depth Freq"

#define CUSTOM_KEY_FRAME_SYNC           "Frame Sync"
