...
enum CaptureFeatureFeatureID {
    ...
    FID_FUSION_ZOOM_3RD_PARTY,
    FID_AINR_YUV,
    FID_RELIGHTING_3RD_PARTY,
    FID_AINR_YHDR,
    FID_AIHDR,
    FID_ZSDHDR_3RD_PARTY,
    NUM_OF_FEATURE,
    NULL_FEATURE = 0xFF,
};
...
public:
    ...
    virtual std::vector<NSCam::IImageBuffer*>    nativeAll() = 0;

    virtual MBOOL                   isMultiBuffer() = 0;
    /*
     * Release the metadata to the caller
     */
    virtual void                    release() = 0;
...
public:
    ...
    virtual MINT32                  getParameter(ParameterID_T, MBOOL isGetCross = MTRUE) = 0;
