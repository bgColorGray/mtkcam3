...
public:
    ...
    /**
     *  To queue the mss source image to capturer if the mss image
     *  buffers are provided from other module.
     *
     *  @param img              - IMfllImageBuffer contains mss s1 source image.
     *  @return                 - If succeed returns MfllErr_Ok;
     */
    virtual enum MfllErr queueSourceMssImage(sp<IMfllImageBuffer>& /*img*/)
    {
        /*default not supported*/
    ...
    /**
     *  To queue the decso buffer to capturer if the dceso image
     *  buffers are provided from other module.
     *
     *  @param buf              - IMfllImageBuffer contains dceso buffer.
     *  @return                 - If succeed returns MfllErr_Ok;
     */
    virtual enum MfllErr queueSourceDcesoBuf(sp<IMfllImageBuffer>& /*buf*/)
    {
        /*default not supported*/
        return MfllErr_NotImplemented;
    };
