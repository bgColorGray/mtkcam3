...
namespace mfll {
    ...
    enum MfllBuffer
    {
        ...
        /* Get the MSS YUV frame of the current stage */
        MfllBuffer_MssYuv,
        ...
        /* Get the Ds weighting table of the current stage */
        MfllBuffer_WeightingDs,
        ...
        /* Since MFNR v4.0, Difference Image buffer has been introduced. */
        MfllBuffer_DifferenceImage,
    ...
    enum ImageFormat
    {
        ...
        ImageFormat_YUV_P012,   // 420 format, 12bit, 2 plane (Y),(UV) = P012 pack
        ImageFormat_YUV_P012_UP,// 420 format, 12bit, 2 plane (Y),(UV) = P012 unpack
        ImageFormat_Nv16,       // NV16:
        ImageFormat_Sta8,       // for weighting table, size = 1 x @ImageSensor
    ...
    enum YuvStage
    {
        ...
        YuvStage_Mss,           // new for ISP6s
        YuvStage_Msf,           // new for ISP6s
        /* size */
        YuvStage_Size
    };
    ...
    enum EventType
    {
        ...
        EventType_AllocateMssBuffer, /* param1: integer, index of buffer */
        ...
        EventType_CaptureMss, /* param1: integer, index of captured MSS */
...
//
    ...
    typedef struct MfllBypassOption
    {
        ...
        volatile unsigned int bypassAllocMssBuffer[MFLL_MAX_FRAMES];
        ...
        volatile unsigned int bypassAllocWeighting[3];
        ...
        volatile unsigned int bypassEncodeMss[MFLL_MAX_FRAMES];
