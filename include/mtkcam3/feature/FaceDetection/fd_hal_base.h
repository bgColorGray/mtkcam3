...
public:
    ...
    //
    /////////////////////////////////////////////////////////////////////////
    virtual MINT32 halFDInit(MUINT32 /*fdW*/, MUINT32 /*fdH*/, MUINT8* /*WorkingBuffer*/, MUINT32 /*WorkingBufferSize*/, MBOOL /*isP1Yuv*/, MUINT8 /*Current_mode*/
                           , MINT32 FldNum = 1, MBOOL isNormalWorld = true) {(void) FldNum; (void) isNormalWorld; return 0;}
