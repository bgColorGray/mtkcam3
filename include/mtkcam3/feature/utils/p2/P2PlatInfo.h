...
typedef enum P2_PQ_INDEX
{
    ...
    P2_PQ_SMVRBATCH         = 9,
    // PIP
    P2_PQ_GEN_PIP_2ND       = 10,
    P2_PQ_GEN_PIP_OTH       = 11,
    P2_PQ_VEN_PIP_1ST       = 12,
    P2_PQ_VEN_PIP_2ND       = 13,
    P2_PQ_VEN_PIP_OTH       = 14,
...
public:
    ...
    public:
        ...
        uint32_t mP1OutRatioMultiple = 1;
        uint32_t mP1OutRatioDivider = 1;
    };

    class NVRamMSYUV_3DNR {
    public:
        uint32_t mMSYUV_MS5_RSV1 = 0;
        uint32_t mMSYUV_MS5_RSV2 = 0;
        uint32_t mMSYUV_MS5_RSV3 = 0;
        uint32_t mMSYUV_MS5_RSV4 = 0;
    };
...
public:
    ...
    virtual P2PlatInfo::NVRamMSYUV_3DNR queryMSYUV_RSV(MINT32 magic3A, MUINT8 ispProfile) const = 0;
    ...
    virtual MSize getYnrLceiSizeLimit() const = 0;
