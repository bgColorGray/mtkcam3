...
public:
    MBOOL init(char const* szCallerName,
                ...
                const DipUsageHint &dipUsageHint = DipUsageHint() ) override;
...
private:
    ...
    static bool normalStreamEarlyCB(const FrameParams &f, NSIoPipe::EFrameCallBackMsg msg);
...
private:
    ...
    struct CookieExt
    {
        ...
        typedef void                (*PFN_DIP_EARLY_CALLBACK_T)(MVOID *cookie);
        PFN_DIP_EARLY_CALLBACK_T    mpfnDIPEarlayCallback = NULL;   //call back for partial callback
