...
using NSCam::NSIoPipe::DipUserParam;
...
public:
    ...
    typedef void (*PFN_FRAMECB_T)(MVOID* cookie);  // SFP customize per frame callback
...
public:
    ...
    uint64_t                    mSeqNum = 0;
    MINT32                      mEarlyCBIndex = -1; // If set, will do p2 early callback when mvDIPFrameParams[index] done
};
...
public:
   MUINT32 mSecTag = 0;
   MUINT32 mMaxEnqueDepth = 0;
   MUINT32 mMaxSubFrameNum = 0;
   MUINT32 mMaxSMVRBatchNum = 0;
};
...
public:
    virtual MBOOL init(char const* szCallerName,
                ...
                const DipUsageHint &dipUsageHint = DipUsageHint()) = 0;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
protected:
    DipUserParam toDipUserParam(const DipUsageHint &hint) const;
