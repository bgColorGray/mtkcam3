...
#define ALGO_EIS35_MODE         (6)
#define ALGO_EIS50_MODE         (7)
...
public:
    ...
    virtual MINT32 DoRSCMEEis(EIS_HAL_CONFIG_DATA *apEisConfig, IMAGE_BASED_DATA *imgBaseData,
        MINT64 aTimeStamp, MUINT32 aExpTime, MUINT32 aLExpTime, MUINT32 staggerNum, EIS_HAL_OUT_DATA& outData) = 0;
