...
public:
    ...
    //  @param mssImg           Source image, mss size one.
    //  @param decso            DCESO buffer from P2A.
...
public:
    ...
    inline int                  getSensorMode() const noexcept { return m_sensorMode; }
    ...
    inline int                  getBssNvramIndex() const noexcept  { return m_BssNvramIndex; }
    inline int                  getMfnrNvramIndex() const noexcept  { return m_MfnrNvramIndex; }
    inline int                  getMfnrThNvramIndex() const noexcept  { return m_MfnrThNvramIndex; }
    ...
    inline int                  getMaxFrameNum() const noexcept    { return m_maxFrameNum; }
    ...
    inline int                  getZslTimeoutMs() const noexcept { return m_zslTimeoutMs; }
    ...
    inline int                  getIspTuningHint() noexcept { return m_ispTuningHint; }
    inline MrpMode              getMrpMode() noexcept { return m_mrpMode; }

    // set
    inline void                 setOpenId(const int& id) noexcept { m_openId = id; }
    inline void                 setSensorMode(const int& m) noexcept { m_sensorMode = m; }
    ...
    inline void                 setBssNvramIndex(int idx) noexcept { m_BssNvramIndex = idx; }
    inline void                 setMfnrNvramIndex(int idx) noexcept { m_MfnrNvramIndex = idx; }
    inline void                 setMfnrThNvramIndex(int idx) noexcept { m_MfnrThNvramIndex = idx; }
    ...
    inline void                 setMaxFrameNum(int b) noexcept { m_maxFrameNum = b; }
    ...
    inline void                 setZslTimeoutMs(int d) noexcept { m_zslTimeoutMs = d; }
    ...
    inline void                 setIspTuningHint(int d) noexcept { m_ispTuningHint = d; }

    void                        setMrpMode(MrpMode m);
...
private:
    ...
    int                         m_finalRealIso;
    int                         m_BssNvramIndex;
    int                         m_MfnrNvramIndex;
    int                         m_MfnrThNvramIndex;
    ...
    int                         m_zslTimeoutMs; // that IHal3A suggested zsl timeout(ms)
