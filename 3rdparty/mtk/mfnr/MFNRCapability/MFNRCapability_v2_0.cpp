 ...
 */
#define LOG_TAG "MFNRCapability_v2_0"
...
MFNRCapability_v2_0::MFNRCapability_v2_0()
{
    FUNCTION_SCOPE;
...
bool MFNRCapability_v2_0::updateInputBufferInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
...
bool MFNRCapability_v2_0::updateOutputBufferInfo(Selection& sel)
{
    sel.mOBufferFull
        .setRequired(MTRUE)
...
bool MFNRCapability_v2_0::updateMultiCamInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
