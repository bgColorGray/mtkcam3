 ...
 */
#define LOG_TAG "MFNRCapability_v2_5"
...
MFNRCapability_v2_5::MFNRCapability_v2_5()
{
    FUNCTION_SCOPE;
...
bool MFNRCapability_v2_5::updateInputBufferInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
...
bool MFNRCapability_v2_5::updateOutputBufferInfo(Selection& sel)
{
    sel.mOBufferFull
        .setRequired(MTRUE)
...
bool MFNRCapability_v2_5::updateMultiCamInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
