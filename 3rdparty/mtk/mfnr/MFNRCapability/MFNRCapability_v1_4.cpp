 ...
 */
#define LOG_TAG "MFNRCapability_v1_4"
...
MFNRCapability_v1_4::MFNRCapability_v1_4()
{
    FUNCTION_SCOPE;
...
bool MFNRCapability_v1_4::updateInputBufferInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
...
bool MFNRCapability_v1_4::updateOutputBufferInfo(Selection& sel)
{
    sel.mOBufferFull
        .setRequired(MTRUE)
...
bool MFNRCapability_v1_4::updateMultiCamInfo(std::shared_ptr<MFNRShotInfo> /*pShotInfo*/, Selection& /*sel*/)
{
    return true;
}
