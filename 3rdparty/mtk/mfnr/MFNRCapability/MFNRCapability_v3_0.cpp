 ...
 */
#define LOG_TAG "MFNRCapability_v3_0"
...
MFNRCapability_v3_0::MFNRCapability_v3_0()
{
    FUNCTION_SCOPE;
...
bool MFNRCapability_v3_0::updateInputBufferInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
...
bool MFNRCapability_v3_0::updateOutputBufferInfo(Selection& sel)
{
...
bool MFNRCapability_v3_0::updateMultiCamInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& sel)
{
