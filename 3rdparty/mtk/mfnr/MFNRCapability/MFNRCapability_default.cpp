 ...
 */
#define LOG_TAG "MFNRCapability_default"
...
MFNRCapability_default::MFNRCapability_default()
{
    FUNCTION_SCOPE;
...
bool MFNRCapability_default::updateInputBufferInfo(std::shared_ptr<MFNRShotInfo> pShotInfo, Selection& /*sel*/)
{
    MY_LOGE("MFNR Provider is not support for mfnrcore(%s)", pShotInfo->getMfnrCoreVersionString().c_str());
    return false;
}

bool MFNRCapability_default::updateOutputBufferInfo(Selection& /*sel*/)
{
    return false;
}

bool MFNRCapability_default::updateMultiCamInfo(std::shared_ptr<MFNRShotInfo> /*pShotInfo*/, Selection& /*sel*/)
{
    return false;
}

MSize MFNRCapability_default::getYUVAlign()
{
    return MSize(64, 16);
}

MSize MFNRCapability_default::getQYUVAlign()
{
    return MSize(16, 16);
}
