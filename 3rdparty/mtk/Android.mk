...
ifneq (,$(filter $(SUPPORTED_PLATFORM),$(MTKCAM_TARGET_BOARD_PLATFORM)))
# --------------------------------------------------------------------
#adf
...
LOCAL_WHOLE_STATIC_LIBRARIES += libmtkcam.plugin.zsdhdr
endif
# AINR
ifneq ($(strip $(MTKCAM_HAVE_AINR_SUPPORT)),0)
...
# AIHDR
ifneq ($(strip $(MTKCAM_HAVE_AIHDR_SUPPORT)),0)
...
# MSNR
ifneq ($(strip $(MTK_CAM_SINGLE_NR_SUPPORT)),no)
ifeq ($(MTKCAM_OPT_MSNR),yes)
LOCAL_WHOLE_STATIC_LIBRARIES += libmtkcam.plugin.msnr
