...
#define LOG_TAG "PipelinePlugin/TPZoomFusionProvider"
 ...
 */
class TPZoomFusionProvider final: public FusionPlugin::IProvider
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    TPZoomFusionProvider();
...
#if FUSION_SUPPORT
REGISTER_PLUGIN_PROVIDER(Fusion, TPZoomFusionProvider);
#endif
/**
 * @brief utility class
 */
class TPZoomFusionUtility final
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Instantiation.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
    TPZoomFusionUtility() = delete;

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  TPZoomFusionUtility Public Operations.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
public:
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  TPZoomFusionUtility implementation.
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
ImageTransformPtr
TPZoomFusionUtility::
createImageTransformPtr()
{
    return ImageTransformPtr(IImageTransform::createInstance("TPZoomFusionProvider", -1, IImageTransform::OPMode_DisableWPE), [](IImageTransform *p)
    {
        p->destroyInstance();
    });
}
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  TPZoomFusionProvider implementation.
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
TPZoomFusionProvider::
TPZoomFusionProvider()
: mEnable(-1)
{
    MY_LOGD("ctor:%p", this);
    // on:1/off:0/auto:-1
    mEnable = ::property_get_int32("vendor.debug.camera.tp.zoomfusion.enable", mEnable);
}
...
property()
{
    ...
    {
        Property ret;
        ret.mName = "TP_ZOOM_FUSION";
        ret.mFeatures = TP_FEATURE_ZOOM_FUSION;
...
process(RequestPtr requestPtr, RequestCallbackPtr callbackPtr)
{
    ...
    //
    {
        ...
        ImgPtr inMainImgPtr = TPZoomFusionUtility::createImgPtr(requestPtr->mIBufferFull);
        ImgPtr inSubImgPtr = TPZoomFusionUtility::createImgPtr(requestPtr->mIBufferFull2);
        ImgPtr outFSImgPtr = TPZoomFusionUtility::createImgPtr(requestPtr->mOBufferFull);
        //
        MetaPtr inAppMetaPtr = TPZoomFusionUtility::createMetaPtr(requestPtr->mIMetadataApp);
        MetaPtr inMainHalMetaPtr = TPZoomFusionUtility::createMetaPtr(requestPtr->mIMetadataHal);
        MetaPtr inSubHalMetaPtr = TPZoomFusionUtility::createMetaPtr(requestPtr->mIMetadataHal2);
        MetaPtr outAppMetaPtr = TPZoomFusionUtility::createMetaPtr(requestPtr->mOMetadataApp);
        MetaPtr outHalMetaPtr = TPZoomFusionUtility::createMetaPtr(requestPtr->mOMetadataHal);
        // dump info
        {
            TPZoomFusionUtility::dump(inMainImgPtr.get(), "inputMainImg");
            TPZoomFusionUtility::dump(inSubImgPtr.get(), "inputSubImg");
            TPZoomFusionUtility::dump(outFSImgPtr.get(), "outFSImg");
            //
            TPZoomFusionUtility::dump(inAppMetaPtr.get(), "inAppMeta");
            TPZoomFusionUtility::dump(inMainHalMetaPtr.get(), "inMainHalMeta");
            TPZoomFusionUtility::dump(inSubHalMetaPtr.get(), "inSubHalMeta");
            TPZoomFusionUtility::dump(outAppMetaPtr.get(), "outAppMeta");
            TPZoomFusionUtility::dump(outHalMetaPtr.get(), "outHalMeta");
        }
        // copy input yuv to output yuv
        {
            AUTO_TIMER("proces fusion algo.");

            ImageTransformPtr transformPtr = TPZoomFusionUtility::createImageTransformPtr();
